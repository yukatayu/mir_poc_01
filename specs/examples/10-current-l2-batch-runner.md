...
### batch runner が public behavior として持つもの

- directory discovery
- runtime/static-only classification
- discovery failure と bundle 実行結果の集約
- directory 単位 summary の返却

### batch runner が thin delegation に留めるもの
...
batch runner は、bundle helper へ委譲した per-bundle 実行結果を summary に集約する範囲で、少なくとも次を exact compare 済みとして扱ってよい。
...
- E1 / E2 / E21 / E22 / E3 variant / E6 は runtime bundle として discovery され、sidecar 付きで batch 実行される。
