...
- actual parser spike を切る順序は別問題であり、current comparison では `specs/examples/73-current-l2-first-parser-spike-staging.md` で checker-led staged spike を current next narrow step とする
