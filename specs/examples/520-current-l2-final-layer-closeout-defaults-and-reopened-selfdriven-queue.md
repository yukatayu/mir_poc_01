...
`specs/examples/528` により、この negative pair はさらに

- representative Lean sample set
- committed `samples/lean/current-l2/` corpus
...
- representative Lean sample set `e5 / p06 / p10 / p11 / p12 / p07 / p08 / p09 / p13 / p14` actual Lean execution
