...
### named profile catalog が public behavior として持つもの

- alias 一覧
- alias ごとの literal な `resolved_request`
- unknown alias failure
- named profile 実行が literal な `resolved_request` を持つ profiled execution へ委譲されること

### named profile catalog が thin delegation に留めるもの

- selected counts と concrete fixture suffix の詳細比較
...
catalog layer は、自身の alias 解決と profiled execution への委譲結果として、少なくとも次を exact compare してよい。
