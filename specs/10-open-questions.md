...
48. final-layer closeout queue をどこまで actual package として戻すか。
   ...
   - 未決なのは、secret-key / IFC valid-invalid corpus をどこまで first checker fragment に入れるか、label-flow negative をどこまで source-side checker corpus に入れるか、broader theorem/model-check/order-handoff corpus widening をどこで止めるかである。
