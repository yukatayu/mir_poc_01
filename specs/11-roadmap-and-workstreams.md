...
R7. post-`P20` hot-plug next-package inventory
  - close 済み。`plan/35-post-p20-hotplug-next-package-inventory.md` と companion docs により、post-`P20` kept-later lane を smallest plausible package cuts に分け、current promoted-next package を `P21` runtime-crate hot-plug completed-engine narrow cut に固定した。package-level reopen next は exact label 未固定のまま `rollback / durable migration`、`distributed activation ordering`、`final public hot-plug ABI` の later family に grouped して残す。
P21. runtime-crate hot-plug completed-engine narrow cut
  - promoted next。admitted request/verdict carrier と existing substrate の上に canonical runtime-side engine state progression を narrow に actualize する。rollback / durable migration / distributed activation ordering / final public hot-plug ABI は同じ tranche に混ぜない。
...
2026-04-29 時点で `P0`、`P1`、`P2`、`P3`、`P4`、`P5`、`P6`、`P7`、`P8`、`P9`、`P10`、`P12` current first cut と `P13` / `P14` / `P15` / `P16` / `P17` current first-cut closeout、`P19`、`P20`、`R7` は close し、`P11` current third cut は actualize 済み、`P18` repo-side first cut も close 済みであり、current promoted-next package は `P21` runtime-crate hot-plug completed-engine narrow cut、package-level reopen next は exact label 未固定の later family grouping である。
