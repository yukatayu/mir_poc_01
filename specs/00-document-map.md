...
- `docs/research_abstract/`
  ...
  - `surface_mir_alpha_01.md` は、Surface Mir brace/source-authority rebaseline、P-SURF-01 parser floor、canonical `S { ... }`、no `S[ ... ]` sugar、indexed state、role admission、source patch hot-plug、next package `P-SURF-02` を reader-facing に短く読むための summary である。
...
- `docs/hands_on/`
  ...
  - `surface_mir_alpha_01.md` は、Surface Mir alpha source-authority roadmap、canonical `S { ... }` place-scope syntax、P-SURF-01 parser commands、stop lines、次 package `P-SURF-02` を読む landing page である。
