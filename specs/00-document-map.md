...
- `docs/hands_on/`
  ...
  - `surface_mir_alpha_01.md` は、Surface Mir alpha source-authority roadmap、canonical `S { ... }` place-scope syntax、P-SURF-01 parser commands、P-SURF-02 indexed-state checker commands、P-SURF-03/P-SURF-04 elaboration/generated-communication commands、stop lines、次 package `P-SURF-05` を読む landing page である。
