...
CURRENT_FIXED_SUBSET_FIRST_CLUSTER: tuple[InventoryRow, ...] = (
    ...
    InventoryRow(
        ...
        authored_status="source-authored",
        expected_static="underdeclared",
        expected_runtime="not_evaluated",
        formal_hook="fixture_static_cluster",
        note="underdeclared lineage omission source actualization",
    ),
    InventoryRow(
        sample_stem="e12-underdeclared-target-missing",
        authored_status="source-authored",
        expected_static="underdeclared",
        expected_runtime="not_evaluated",
        formal_hook="fixture_static_cluster",
        note="underdeclared target omission source actualization",
    ),
    InventoryRow(
