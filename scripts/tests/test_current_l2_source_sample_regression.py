...
class SourceSampleRegressionInventoryTests(unittest.TestCase):
    def test_inventory_rows_cover_authored_and_deferred_entries(self) -> None:
        ...
        self.assertEqual(
            [row.authored_status for row in rows[:16]],
            [
                "source-authored",
                "source-authored",
                "source-authored",
        ...
        self.assertEqual(
            [row.formal_hook for row in rows],
            [
    ...
    def test_format_inventory_text_includes_header_rows_and_file_state(self) -> None:
        ...
        self.assertIn(
            "e5-underdeclared-lineage | source-authored | underdeclared | not_evaluated",
            rendered,
        )
        self.assertIn(
            "e12-underdeclared-target-missing | source-authored | underdeclared | not_evaluated",
            rendered,
        )
        self.assertIn(
    ...
    def test_plan_regression_commands_uses_expected_order_and_smoke_plumbing(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                "static formal hook smoke for e5-underdeclared-lineage",
                "static formal hook smoke for e12-underdeclared-target-missing",
