...
class MirComputationalSamplesTests(unittest.TestCase):
    ...
    def test_run_comp_02_rejects_as_planned_only(self) -> None:
        ...
        self.assertIn("P-COMP-02", result["rejection_reason"])
    ...
    def test_closeout_records_stop_lines_and_non_claims(self) -> None:
        ...
        self.assertEqual(result["current_add_one_reading"], "host_boundary_only")
        self.assertIn("no runtime completion yet", result["stop_lines"])
        self.assertIn(
