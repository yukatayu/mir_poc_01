...
- Full System V1 helper family now has parser-floor, typed-checker-floor, bounded runtime commands, PoseGraph runtime commands, bounded projection IR + boundary-schema commands, and bounded same-binary local role-split commands plus later planned commands
