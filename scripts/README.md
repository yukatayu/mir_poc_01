...
- Full System V1 helper family now has parser-floor, typed-checker-floor, bounded runtime commands, PoseGraph runtime commands, and bounded projection IR + boundary-schema commands plus later planned commands
