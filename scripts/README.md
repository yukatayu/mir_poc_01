...
- Surface Mir helper family has a P-SURF-01 parser floor, P-SURF-02 indexed-state semantic checker floor, P-SURF-03 elaboration evidence floor, and P-SURF-04 generated communication evidence floor
  ...
  - this helper floor does not claim runtime MessageEnvelope dispatch, role admission completion, source patch activation, final grammar/API, or package artifact authority
