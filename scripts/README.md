...
- `validate_docs.py`
  required documentation scaffold と numbered report の存在を確認する scaffold check。semantic validation、active/current wording lint、sample execution、Cargo validation は別 command の責務。
