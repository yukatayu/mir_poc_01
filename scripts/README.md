...
- product alpha-1 CLI/schema first cut now has a Rust CLI surface
  ...
  - portal/shard authoring is also intentionally not given a separate starter helper yet; use `docs/hands_on/operational_portal_shard_starter_boundary_01.md` and the active `portal-worldlink/` / `two-shard-hard-boundary/` roots directly
