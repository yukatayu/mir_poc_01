...
2. Phase 5 を reopen する場合は、exchange-body threshold をどこまで theorem-line bridge に寄せるかを先に narrow に扱う
...
- 2026-04-10 01:41 JST — Phase 5 theorem-line later package の次段として `specs/examples/155-current-l2-theorem-line-validation-ready-invocation-surface-threshold.md` を整理し、validation-ready retained bridge に `consumer_invocation_surface_ref` までを current first choice に固定した。next later reopen は exchange-body threshold の comparison に更新した。
