...
| Phase 5 | 97% | static analysis / type / theorem prover / async-control boundary | current package close | とても重い | 自走可能 | `126...278` まで current package close。next promoted line は minimal-public-checker-entry-criteria-ready public-checker-command-surface comparison |
...
1. **Phase 5 later reopen**
   - minimal-public-checker-entry-criteria-ready public-checker-command-surface comparison を next promoted line に置く。
...
| static analysis / type / theorem prover / async-control boundary | 99% | 98% | 34% | 着手可能 | `126...278` まで current package close。next は minimal-public-checker-entry-criteria-ready public-checker-command-surface comparison |
...
1. **Phase 5 later reopen** として `minimal-public-checker-entry-criteria-ready public-checker-command-surface comparison` を扱う
