...
| --- | --- | --- |
| Logical specification | M0--M3 are evidence-complete; official lifecycle is T1; M4 maintained relation/late projection is active | **着手可能**: bird relation, fallback, C-local projection calculus |
...
receipt, and designated publication/explicit consumption evidence. Its direct
consumer is M4 relation/projection semantics; official conformance and M8
...
| M4 | maintained relation/late projection | active | bird/shoulder relation DAG, late projection, fallback/privacy |
| M5 | shared model/metatheory | next | after M4 |
...
| 1 | semantics/shared model | M1--M5; M4 is active cut after accepted M3 calculus | heavy | yes |
...
| contracts/theorem/model-check | finite M3 OBL-029--034 evidence; general ledger deferred | M4--M5 shared statements | later |
