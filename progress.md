...
- **Phase 5** は `specs/examples/126...246` までで theorem-line later package close である。small decidable core / proof / async-control boundary inventory と theorem-side retained bridge は `retained_payload_body_materialization_theorem_export_handoff_transport_family` を current first choice に置いており、**next later reopen** は `minimal-handoff-transport-family-ready handoff-transport-carrier-detail comparison` に置いている。
...
| Phase 5 | 89% | static analysis / type / theorem prover / async-control boundary | theorem-line later package close | とても重い | 自走可能 | `126...246` まで current package close。next reopen は minimal-handoff-transport-family-ready handoff-transport-carrier-detail comparison |
...
1. **Phase 5 later reopen**
   - minimal-handoff-transport-family-ready handoff-transport-carrier-detail comparison を next promoted line に置く。
...
| static analysis / type / theorem prover / async-control boundary | 99% | 98% | 25% | 着手可能 | `126...246` まで current package close。next は minimal-handoff-transport-family-ready handoff-transport-carrier-detail comparison |
...
1. **Phase 5 later reopen** として `minimal-handoff-transport-family-ready handoff-transport-carrier-detail comparison` を扱う
