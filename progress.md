...
- **Phase 5** は `specs/examples/126...238` までで theorem-line later package close である。small decidable core / proof / async-control boundary inventory と theorem-side retained bridge は `retained_payload_body_materialization_theorem_export_handoff_witness_row` を current first choice に置いており、**next later reopen** は `minimal-handoff-witness-row-detail-ready replay-attachment-ref comparison` に置いている。
...
| Phase 5 | 87% | static analysis / type / theorem prover / async-control boundary | theorem-line later package close | とても重い | 自走可能 | `126...238` まで current package close。next reopen は minimal-handoff-witness-row-detail-ready replay-attachment-ref comparison |
...
1. **Phase 5 later reopen**
   - minimal-handoff-witness-row-detail-ready replay-attachment-ref comparison を next promoted line に置く。
...
| static analysis / type / theorem prover / async-control boundary | 99% | 98% | 23% | 着手可能 | `126...238` まで current package close。next は minimal-handoff-witness-row-detail-ready replay-attachment-ref comparison |
...
1. **Phase 5 later reopen** として `minimal-handoff-witness-row-detail-ready replay-attachment-ref comparison` を扱う
