...
| strong typing / IFC closeout | 96% | 93% | 85% | phase6-actual-checker-runtime-skeleton-first-tranche ratchet までは自走可能 |
...
- current self-driven closeout package:
  phase6-actual-checker-runtime-skeleton-first-tranche ratchet
- remaining stop line:
