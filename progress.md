...
| `Macro 5` | theorem / model-check / verifier bridge | LAB OBL-001, OBL-020, OBL-021, OBL-024, and OBL-025 statement-shape drafts now compile; OBL-001/020/021 and OBL-024/025 have focused sync guards against body/vocabulary drift, and `plan/126` hardens OBL-001/020/021 body-link checks against comment-only satisfaction plus bare `:= True` vacuity, but Surface elaboration soundness / WF preservation / elaboration determinism / diagnostic soundness / repair completeness are not proved or ledger-moved | medium | 着手可能 |
...
audit, SCN-02 direct-local-write blocker review, and OBL-020/021 boundary audit
plus OBL-021 guard hardening.
