...
- **Phase 5 small decidable core / proof / async-control boundary** は、`specs/examples/126-current-l2-small-decidable-core-and-proof-boundary-inventory.md` で 4-way split を current first choice に固定したうえで、`specs/examples/127-current-l2-proof-obligation-matrix-and-external-handoff-artifact.md` で proof-obligation matrix と source evidence 参照の mixed handoff row sketch を切り、`specs/examples/128-current-l2-handoff-artifact-threshold-comparison.md` で mixed row bundle を current docs-only default に維持し、boundary-specific handoff artifact と actual emitter は concrete consumer pressure が出たときだけ reopen する threshold を固定した。さらに `specs/examples/129-current-l2-first-external-consumer-pressure-comparison.md` で、first concrete external consumer pressure の current first practical candidate を `theorem_prover_boundary` に置き、`specs/examples/130-current-l2-theorem-line-narrow-actualization-comparison.md` で theorem-side projection bundle を docs-only first cut に置き、`specs/examples/131-current-l2-theorem-line-evidence-ref-family-comparison.md` で typed symbolic `evidence_refs` family を current first choice に置き、`specs/examples/132-current-l2-theorem-line-public-checker-migration-threshold.md` で public checker migration を concrete theorem consumer pressure が出るまで deferred に保つ threshold を固定した。その次段として `specs/examples/133-current-l2-theorem-line-minimum-contract-row-comparison.md` で theorem-side minimum contract row core を `obligation_kind + evidence_refs` に留め、`specs/examples/134-current-l2-theorem-line-consumer-class-comparison.md` で `proof_notebook` を first practical consumer class に置き、`specs/examples/135-current-l2-theorem-line-notebook-attachment-family-comparison.md` で notebook first bridge の attachment を `goal_text` に留め、`specs/examples/136-current-l2-theorem-line-notebook-bridge-artifact-threshold.md` で current phase では notebook bridge artifact を docs-only derived view に留め、`specs/examples/137-current-l2-theorem-line-next-consumer-pressure-comparison.md` で next practical reopen order を notebook workflow pressure first / `proof_assistant_adapter` second に固定し、`specs/examples/138-current-l2-theorem-line-concrete-notebook-workflow-pressure-comparison.md` で concrete notebook workflow pressure の current first threshold を human review checklist / walkthrough pressure に置き、`specs/examples/139-current-l2-theorem-line-notebook-review-unit-named-bundle-threshold.md` で review unit を docs-only named bundle に寄せ、`specs/examples/140-current-l2-theorem-line-review-unit-to-bridge-sketch-comparison.md` で bridge-level の docs-only sketch に寄せ、`specs/examples/141-current-l2-theorem-line-bridge-sketch-compare-metadata-threshold.md` で compare basis refs を、`specs/examples/142-current-l2-theorem-line-compare-ready-bridge-bless-decision-threshold.md` で bless decision state を、`specs/examples/143-current-l2-theorem-line-bless-ready-bridge-review-session-threshold.md` で review-note refs を、`specs/examples/144-current-l2-theorem-line-review-linked-bless-bridge-retained-notebook-threshold.md` で retained-notebook ref を、`specs/examples/145-current-l2-theorem-line-retained-bridge-review-session-link-threshold.md` で review-session ref を、`specs/examples/146-current-l2-theorem-line-session-linked-retained-bridge-review-observation-threshold.md` で `reviewed_by_ref + reviewed_at_ref` を、`specs/examples/147-current-l2-theorem-line-observed-session-lifecycle-threshold.md` で `review_session_state` を、`specs/examples/148-current-l2-theorem-line-lifecycle-ready-retention-state-threshold.md` で `retention_state` を、`specs/examples/149-current-l2-theorem-line-retention-ready-path-policy-threshold.md` で `retained_path_policy_ref` を、`specs/examples/150-current-l2-theorem-line-path-ready-emitted-artifact-threshold.md` で `emitted_artifact_ref` を、`specs/examples/151-current-l2-theorem-line-emitted-ready-handoff-emitter-threshold.md` で `handoff_emitter_ref` を、`specs/examples/152-current-l2-theorem-line-emitter-linked-consumer-adapter-threshold.md` で `consumer_adapter_ref` を、`specs/examples/153-current-l2-theorem-line-adapter-linked-exchange-rule-threshold.md` で `exchange_rule_ref` を、`specs/examples/154-current-l2-theorem-line-exchange-ready-adapter-validation-threshold.md` で `adapter_validation_ref` を、`specs/examples/155-current-l2-theorem-line-validation-ready-invocation-surface-threshold.md` で `consumer_invocation_surface_ref` を、`specs/examples/156-current-l2-theorem-line-invocation-ready-exchange-body-threshold.md` で `exchange_rule_body_ref` を、`specs/examples/157-current-l2-theorem-line-exchange-body-ready-runtime-coupling-threshold.md` で `runtime_coupling_ref` を current first choice に置くところまで進めた。したがって current package は theorem-line later package close とみなし、next later reopen は transport / failure threshold の comparison に寄せてよい。
...
2. Phase 5 current package は checkpoint close として維持し、notebook exchange rule threshold をどこまで足すかが必要になったときだけ later pressure で reopen する
...
| static analysis / type / theorem prover / async-control boundary | 92% | 81% | 14% | 着手可能 | `specs/examples/126...` で 4-way split、`specs/examples/127...` で proof-obligation matrix と mixed handoff sketch、`specs/examples/128...` で mixed row default と boundary-specific split / actual emitter の reopen threshold、`specs/examples/129...` で theorem first / protocol second / runtime later の pressure order、`specs/examples/130...` で theorem-side projection bundle、`specs/examples/131...` で typed symbolic `evidence_refs` family、`specs/examples/132...` で public checker migration defer threshold、`specs/examples/133...` で minimum contract row core、`specs/examples/134...` で `proof_notebook` first consumer、`specs/examples/135...` で `goal_text` attachment、`specs/examples/136...` で notebook bridge artifact を docs-only derived view に留める threshold、`specs/examples/137...` で next reopen order を notebook workflow first / `proof_assistant_adapter` second に固定、`specs/examples/138...` で workflow pressure の first threshold を review checklist / walkthrough に固定、`specs/examples/139...` で review unit を docs-only named bundle に寄せ、`specs/examples/140...` で bridge-level の docs-only sketch、`specs/examples/141...` で compare basis refs、`specs/examples/142...` で bless decision state、`specs/examples/143...` で review-note refs、`specs/examples/144...` で retained-notebook ref、`specs/examples/145...` で review-session ref、`specs/examples/146...` で `reviewed_by_ref + reviewed_at_ref`、`specs/examples/147...` で `review_session_state`、`specs/examples/148...` で `retention_state`、`specs/examples/149...` で `retained_path_policy_ref`、`specs/examples/150...` で `emitted_artifact_ref`、`specs/examples/151...` で `handoff_emitter_ref`、`specs/examples/152...` で `consumer_adapter_ref`、`specs/examples/153...` で `exchange_rule_ref`、`specs/examples/154...` で `adapter_validation_ref`、`specs/examples/155...` で `consumer_invocation_surface_ref`、`specs/examples/156...` で `exchange_rule_body_ref`、`specs/examples/157...` で `runtime_coupling_ref`、`specs/examples/158...` で `transport_protocol_ref` までを current first choice に固定。next は failure-body threshold をどこまで足すか |
...
2. Phase 5 を reopen する場合は、failure-body threshold をどこまで theorem-line bridge に寄せるかを先に narrow に扱う
