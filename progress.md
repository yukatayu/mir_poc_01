...
| strong typing / IFC closeout | 96% | 93% | 86% | phase6-reserve-formal-tool-binding-inventory ratchet までは自走可能 |
...
- `Package 85` phase6-reserve-formal-tool-binding-inventory ratchet
  - `CurrentL2SecondTrancheManifest` の次段として、theorem-first reserve / model-check second reserve / tool-neutral formal-hook keep / parser-side mainline keep の minimum を helper-local manifest と snapshot docs に ratchet する
