...
- operational suite では broader room-chat revisit、portal/shard starter revisit、broader Sugoroku revisit に続いて later room-chat reopening queue-state hardening も閉じ、helper-reported `widening_queue_scope` により next queue は broader Sugoroku reopening に戻った
...
- WAN / distributed durable save-load / engine adapter scope は broader Sugoroku reopening 後も later gate のまま
