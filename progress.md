...
| strong typing / IFC closeout | 92% | 86% | 72% | checker payload public-checker-api sketch ratchet までは自走可能 |
...
- `Package 68` checker payload public-checker-api sketch ratchet
  - `actual_checker_payload_public_schema_sketch_threshold` の次段として `checker_subject + public_checker_payload_schema_ref` の `public_checker_api_ready_sketch` を helper-local summary へ ratchet する
