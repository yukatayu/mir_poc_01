...
- **Phase 5** は `specs/examples/126...252` までで theorem-line later package close である。small decidable core / proof / async-control boundary inventory と theorem-side retained bridge は `retained_payload_body_materialization_theorem_export_handoff_transport_receipt_row` を current first choice に置いており、**next later reopen** は `minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison` に置いている。
...
| Phase 5 | 90% | static analysis / type / theorem prover / async-control boundary | theorem-line later package close | とても重い | 自走可能 | `126...252` まで current package close。next reopen は minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison |
...
1. **Phase 5 later reopen**
   - minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison を next promoted line に置く。
...
| static analysis / type / theorem prover / async-control boundary | 99% | 98% | 26% | 着手可能 | `126...252` まで current package close。next は minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison |
...
1. **Phase 5 later reopen** として `minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison` を扱う
