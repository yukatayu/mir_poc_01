...
- product alpha-1 release-candidate workflow と operational suite first cut は入ったが、public packaging adoption target はまだ未固定であり、final public grammar / ABI / WAN / distributed durable save-load はその後段に残る
- operational suite では packaging-adoption scoping が current queue に残り、broader multi-message room-chat widening と portal/shard starter revisit は later decision として残る
...
- final public grammar / ABI / WAN / distributed durable save-load / engine adapter scope は packaging-adoption scoping 後の later gate のまま
