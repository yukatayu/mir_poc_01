...
5. Plans 208--211 prepare and execute B2-OPAQUE as one bounded finite table:
   ...
   owner-terminal overlap detector; and WRK-0042 passed the separate supplied
   owner-negative/mutation detector. None selects Canon semantics.
...
| Research | selected semantic composition | WRK-0028--0039 retain bounded evidence. Plan 214 is closed at its cut; P017 X1 has passed finite WRK-0040--0042 detectors. No Canon carrier changed |
| Research | C2-B/C3 relation-state model | P017 X1 / WRK-0042 passed finite detector | Run a fresh screen only for an independent source condition and falsifier; otherwise retain scoped `no-candidate`. Schema/rules/proof/source/runtime and every positive relation model remain deferred |
...
| 1 | semantic kernel | directions recorded; proof-facing composition incomplete; X1 has WRK-0040--0042 finite evidence | heavy | yes, within ADR-0014 and P017 scope |
