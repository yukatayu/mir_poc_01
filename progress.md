...
| Phase 5 | 85% | static analysis / type / theorem prover / async-control boundary | theorem-line later package close | とても重い | 自走可能 | `126...234` まで current package close。next reopen は minimal-authority-handoff-epoch-ref-ready witness-aware-handoff-family comparison |
...
1. **Phase 5 later reopen**
   - minimal-authority-handoff-epoch-ref-ready witness-aware-handoff-family comparison を next promoted line に置く。
...
| static analysis / type / theorem prover / async-control boundary | 99% | 98% | 21% | 着手可能 | `126...234` まで current package close。next は minimal-authority-handoff-epoch-ref-ready witness-aware-handoff-family comparison |
...
1. **Phase 5 later reopen** として `minimal-authority-handoff-epoch-ref-ready witness-aware-handoff-family comparison` を扱う
