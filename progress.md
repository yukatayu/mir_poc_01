...
- **Phase 5** は `specs/examples/126...240` までで theorem-line later package close である。small decidable core / proof / async-control boundary inventory と theorem-side retained bridge は `retained_payload_body_materialization_theorem_export_handoff_replay_attachment_ref` を current first choice に置いており、**next later reopen** は `minimal-replay-attachment-ref-ready handoff-payload-ref comparison` に置いている。
...
| Phase 5 | 88% | static analysis / type / theorem prover / async-control boundary | theorem-line later package close | とても重い | 自走可能 | `126...240` まで current package close。next reopen は minimal-replay-attachment-ref-ready handoff-payload-ref comparison |
...
1. **Phase 5 later reopen**
   - minimal-replay-attachment-ref-ready handoff-payload-ref comparison を next promoted line に置く。
...
| static analysis / type / theorem prover / async-control boundary | 99% | 98% | 24% | 着手可能 | `126...240` まで current package close。next は minimal-replay-attachment-ref-ready handoff-payload-ref comparison |
...
1. **Phase 5 later reopen** として `minimal-replay-attachment-ref-ready handoff-payload-ref comparison` を扱う
