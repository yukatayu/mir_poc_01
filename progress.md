...
| Phase 5 | 97% | static analysis / type / theorem prover / async-control boundary | current package close | とても重い | 自走可能 | `126...268` まで current package close。next promoted line は minimal-checker-payload-row-detail-ready checker-payload-row-body comparison |
...
1. **Phase 5 later reopen**
   - minimal-checker-payload-row-detail-ready checker-payload-row-body comparison を next promoted line に置く。
...
| static analysis / type / theorem prover / async-control boundary | 99% | 98% | 33% | 着手可能 | `126...268` まで current package close。next は minimal-checker-payload-row-detail-ready checker-payload-row-body comparison |
