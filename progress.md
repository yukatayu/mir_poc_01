...
- operational suite では broader room-chat revisit、portal/shard starter revisit、broader Sugoroku revisit が current boundary hardening として閉じ、next queue は later room-chat reopening になった
...
- WAN / distributed durable save-load / engine adapter scope は later room-chat reopening 後も later gate のまま
