...
- **Phase 5** は `specs/examples/126...230` までで theorem-line later package close である。small decidable core / proof / async-control boundary inventory と theorem-side retained bridge は `retained_payload_body_materialization_theorem_export_authority_transition_stage_local_obligation_family` を current first choice に置いており、**next later reopen** は `minimal-authority-stage-local-obligation-family-ready stage-local-obligation-row-detail comparison` に置いている。
...
| Phase 5 | 83% | static analysis / type / theorem prover / async-control boundary | theorem-line later package close | とても重い | 自走可能 | `126...230` まで current package close。next reopen は minimal-authority-stage-local-obligation-family-ready stage-local-obligation-row-detail comparison |
...
1. **Phase 5 later reopen**
   - minimal-authority-stage-local-obligation-family-ready stage-local-obligation-row-detail comparison を next promoted line に置く。
...
| static analysis / type / theorem prover / async-control boundary | 99% | 98% | 19% | 着手可能 | `126...230` まで current package close。next は minimal-authority-stage-local-obligation-family-ready stage-local-obligation-row-detail comparison |
...
1. **Phase 5 later reopen** として `minimal-authority-stage-local-obligation-family-ready stage-local-obligation-row-detail comparison` を扱う
