...
| finite-index typing / order-handoff | current scope close | user-defined finite theory、publication / witness / handoff relation | final source principal wording、public checker contract、public witness/provider/emitted-handoff contract |
