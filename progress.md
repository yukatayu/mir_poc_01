...
| strong typing / IFC closeout | 95% | 91% | 78% | verifier-handoff-surface ratchet までは自走可能 |
...
- `Package 73` verifier-handoff-surface ratchet
  - `actual_public_checker_boundary_threshold` の次段として docs-only mixed-row bridge を current cut に留めた verifier-handoff-surface ready sketch を helper-local summary へ ratchet する
