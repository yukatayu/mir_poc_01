...
- **Phase 5** は `specs/examples/126...203` までで theorem-line later package close である。small decidable core / proof / async-control boundary inventory と theorem-side retained bridge は `retained_payload_body_materialization_proof_assistant_adapter_contract` まで current first choice を切れており、**next later reopen** は `proof-assistant-adapter-contract-ready theorem-export-checker-pressure comparison` に置いている。
...
| Phase 5 | static analysis / type / theorem prover / async-control boundary | theorem-line later package close | とても重い | 自走可能 | `126...203` まで current package close。next reopen は proof-assistant-adapter-contract-ready theorem-export-checker-pressure comparison |
...
1. **Phase 5 later reopen**
   - proof-assistant-adapter-contract-ready theorem-export-checker-pressure comparison を next promoted line に置く。
...
| static analysis / type / theorem prover / async-control boundary | 98% | 94% | 18% | 着手可能 | `126...203` まで current package close。next は proof-assistant-adapter-contract-ready theorem-export-checker-pressure comparison |
...
1. **Phase 5 later reopen** として `proof-assistant-adapter-contract-ready theorem-export-checker-pressure comparison` を扱う
