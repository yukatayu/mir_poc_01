...
| strong typing / IFC closeout | 96% | 93% | 86% | fixed-subset-source-sample-corpus-scope-and-file-layout ratchet までは自走可能 |
...
- `Package 88` fixed-subset-source-sample-corpus-scope-and-file-layout ratchet
  - Package 87 close 後の次段として、repo-root `samples/current-l2/` flat `.txt` layer の scope / directory / naming / non-goal minimum を actualize し、mapping matrix / actual sample content / parser-to-`Program` lowering は retained-later に残す
