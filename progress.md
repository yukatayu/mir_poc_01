...
| Phase 5 | 98% | static analysis / type / theorem prover / async-control boundary | current package close | とても重い | 自走可能 | `126...280` まで current package close。next promoted line は minimal-public-checker-command-surface-ready shared-output-contract comparison |
...
1. **Phase 5 later reopen**
   - minimal-public-checker-command-surface-ready shared-output-contract comparison を next promoted line に置く。
...
| static analysis / type / theorem prover / async-control boundary | 99% | 98% | 35% | 着手可能 | `126...280` まで current package close。next は minimal-public-checker-command-surface-ready shared-output-contract comparison |
...
1. **Phase 5 later reopen** として `minimal-public-checker-command-surface-ready shared-output-contract comparison` を扱う
