...
use mir_semantics::surface_to_core_elaboration::elaborate_surface_to_core_path;
use serde_json::json;
...
fn run(args: Vec<String>) -> i32 {
    ...
    let report = elaborate_surface_to_core_path(&path);
    let accepted = report.accepted;
    let payload = json!({
        "surface_kind": "surface_to_core_elaboration_report",
