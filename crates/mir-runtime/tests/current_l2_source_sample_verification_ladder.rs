...
#[test]
fn verification_ladder_marks_e13_as_static_stop_and_static_formal_hook_reached() {
    let source_report = run_current_l2_source_sample(
...
#[test]
fn verification_ladder_marks_e20_as_static_stop_and_static_formal_hook_reached() {
    let source_report = run_current_l2_source_sample(
...
#[test]
fn verification_ladder_marks_e18_as_static_stop_and_static_formal_hook_reached() {
    let source_report = run_current_l2_source_sample(
