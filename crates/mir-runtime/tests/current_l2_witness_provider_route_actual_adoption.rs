...
fn assert_actual_adoption_matches_prior_floors(
    actual_adoption: &CurrentL2SourceSampleWitnessProviderRouteActualAdoption,
    public_shape_actual_adoption: &CurrentL2SourceSampleWitnessProviderArtifactPublicShapeActualAdoption,
    public_schema_coupled_gate: &CurrentL2SourceSampleWitnessProviderPublicSchemaCoupledLaterGate,
    expected_witness_route_actual_refs: &[&str],
    expected_provider_route_actual_refs: &[&str],
    expected_schema_candidate_keep_refs: &[&str],
    expected_compare_floor_refs: &[&str],
    expected_guard_refs: &[&str],
) {
    assert_eq!(
        actual_adoption.actualization_status,
        public_shape_actual_adoption.actualization_status
    );
    assert_eq!(
        actual_adoption.actualization_status,
    ...
    assert_eq!(
        ...
        public_shape_actual_adoption.profile_axis_refs
    );
    assert_eq!(
        actual_adoption.repo_local_emitted_artifact_refs,
        public_shape_actual_adoption.repo_local_emitted_artifact_refs
    );
    assert_eq!(
        actual_adoption.witness_route_actual_refs,
        expected_witness_route_actual_refs
            .iter()
            .map(|entry| entry.to_string())
            .collect::<Vec<_>>()
    );
    assert_eq!(
        actual_adoption.provider_route_actual_refs,
        expected_provider_route_actual_refs
            .iter()
            .map(|entry| entry.to_string())
            .collect::<Vec<_>>()
    );
    assert_eq!(
        actual_adoption.schema_candidate_keep_refs,
        expected_schema_candidate_keep_refs
            .iter()
            .map(|entry| entry.to_string())
            .collect::<Vec<_>>()
    );
...
fn witness_provider_route_actual_adoption_reaches_late_join_witness_sample() {
    ...
    let public_schema_coupled_gate =
        ...
        .unwrap();
    let actual_adoption = build_current_l2_source_sample_witness_provider_route_actual_adoption(
        sample_path.to_str().unwrap(),
        prototype_host_plan(&sample_path),
    )
    .unwrap();
    ...
    assert_actual_adoption_matches_prior_floors(
        ...
        &[
            "witness_provider_route_actual:p07-dice-late-join-visible-history:claim_payload_split_first",
            "witness_provider_route_actual:p07-dice-late-join-visible-history:witness_route_first",
            "witness_provider_route_actual:p07-dice-late-join-visible-history:repo_local_emitted_artifact_refs_first",
            "witness_provider_route_actual:p07-dice-late-join-visible-history:public_schema_candidate_keep",
            "witness_provider_route_actual:p07-dice-late-join-visible-history:combined_public_contract_later",
        ],
        &[],
        &[
            "witness_provider_schema_keep:p07-dice-late-join-visible-history:final_public_witness_schema_candidate_only",
            "witness_provider_schema_keep:p07-dice-late-join-visible-history:combined_public_contract_candidate_only",
            "witness_provider_schema_keep:p07-dice-late-join-visible-history:final_emitted_handoff_contract_adjacent_keep",
        ],
        &[
        ...
        &[
            ...
            "guard:witness_provider_route_first",
            "guard:repo_local_emitted_artifact_refs_first",
            "guard:public_schema_candidate_keep",
...
fn witness_provider_route_actual_adoption_reaches_stale_reconnect_baseline() {
    ...
    assert_actual_adoption_matches_prior_floors(
        ...
        &[],
        &[
            "witness_provider_schema_keep:p08-dice-stale-reconnect-refresh:combined_public_contract_candidate_only",
            "witness_provider_schema_keep:p08-dice-stale-reconnect-refresh:final_emitted_handoff_contract_adjacent_keep",
        ],
        &[
            "compare_floor:current_l2.authoritative_room.vertical_slice",
            "compare_floor:current_l2.witness_provider_artifact.public_shape_threshold",
...
#[test]
fn witness_provider_route_actual_adoption_reaches_delegated_provider_sample() {
    let sample_path =
    ...
    assert_actual_adoption_matches_prior_floors(
        ...
        &[],
        &[
            "witness_provider_route_actual:p09-dice-delegated-rng-provider-placement:provider_route_first",
            "witness_provider_route_actual:p09-dice-delegated-rng-provider-placement:repo_local_emitted_artifact_refs_first",
            "witness_provider_route_actual:p09-dice-delegated-rng-provider-placement:public_schema_candidate_keep",
            "witness_provider_route_actual:p09-dice-delegated-rng-provider-placement:delegated_provider_attestation_later",
            "witness_provider_route_actual:p09-dice-delegated-rng-provider-placement:combined_public_contract_later",
        ],
        &[
            "witness_provider_schema_keep:p09-dice-delegated-rng-provider-placement:final_public_provider_receipt_schema_candidate_only",
            "witness_provider_schema_keep:p09-dice-delegated-rng-provider-placement:combined_public_contract_candidate_only",
            "witness_provider_schema_keep:p09-dice-delegated-rng-provider-placement:final_emitted_handoff_contract_adjacent_keep",
        ],
        &[
...
#[test]
fn witness_provider_route_actual_adoption_keeps_guarded_chain_not_reached() {
    ...
    assert_actual_adoption_matches_prior_floors(
        ...
        &["guard:witness_provider_route_actual_adoption_not_reached"],
    );
}
