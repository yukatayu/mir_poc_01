...
を docs-first に固めたうえで、typed family split、notebook-consumer threshold、model-check small-cluster projection keep/drop、order/handoff source-surface wording reserve まで進め、next reopen を modality internalization trigger note に残す line である。
...
3. shared-space final fairness / replay operational profile mixed gate
4. public operational CLI installed-binary / packaging success-criteria mixed gate
