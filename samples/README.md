...
- `full-system-v1/`
  ...
  - current executable scope is parser plus typed checker plus bounded effectful runtime plus bounded PoseGraph runtime/save-load/devtools evidence; it does not claim final effect grammar, distributed cut/save execution, final devtools family completion, or generated package artifact completion
