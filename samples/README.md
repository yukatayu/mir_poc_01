...
- `alpha/` と `practical-alpha1/` を混同しない
  ...
  - `scripts/practical_alpha05_session.py` はこの root を first bounded α-0.5 same-session carrier として consume するが、typed external host-I/O direct execution はまだ別 package に残る
