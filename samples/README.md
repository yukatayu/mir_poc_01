...
- `alpha/` は current alpha-local theory-freeze / checker/runtime roadmap 用の scaffold であり、expected-verdict sidecar を伴う
  ...
  - `e2e/` は `alpha_e2e_samples.py` により `E2E-01/02/03/04/05/07/09/10` を thin integrated Stage-F bridge として actualize したが、`E2E-06` local save/load と `E2E-08` upper-layer seed は planned-only のまま保つ
