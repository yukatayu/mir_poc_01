...
- `alpha/` と `practical-alpha1/` を混同しない
  ...
  - `practical-alpha1/` もまだ active canonical runnable root ではなく、final object package attach、detach runtime lifecycle、WAN/federation、distributed durable save/load、product surfaces は later packages に残る
