# ELAB-15 RouteUnavailable Singleton Failure Row Negative

Surface source authority:
`main/src/route-unavailable-singleton-failure-row-negative.mir`.

Expected evidence: a generated remote write request with exactly
`RouteUnavailable` omitted remains `E-ROW-001` no-repair evidence.
