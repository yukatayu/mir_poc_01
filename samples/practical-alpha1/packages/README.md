...
- `alpha_local_hotplug_input` currently carries attach-time package-admission lanes such as `membership_epoch`, `member_incarnation`, `required_witness_refs`, and `pre_attach_membership_advances`.
