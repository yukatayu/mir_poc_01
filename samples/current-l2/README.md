...
- repo-level current line は stable malformed missing-option first reopen actualization comparison であり、その後に final public parser/checker/runtime later gate と public operational CLI second gate を reserve に置く
