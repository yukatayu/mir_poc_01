...
- repo-level current line は final public parser/checker/runtime thin-facade later support actualization であり、その後に stable malformed capability second reopen を reserve に置く
