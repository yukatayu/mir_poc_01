...
- repo-level current line は stable malformed missing-option source-backed widening actualization であり、その後に public operational CLI second gate と final public parser/checker/runtime thin-facade later support を reserve に置く
