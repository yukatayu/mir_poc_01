...
- repo-level current line は public operational CLI second later gate actualization comparison であり、その後に final public parser/checker/runtime thin-facade later support と stable malformed capability second reopen を reserve に置く
