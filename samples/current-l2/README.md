...
- repo-level current line は final public parser/checker/runtime first later gate actualization comparison であり、その後に stable malformed missing-option source-backed widening と public operational CLI second gate を reserve に置く
