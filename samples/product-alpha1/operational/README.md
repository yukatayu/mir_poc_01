...
This root holds the operational product sample suite introduced by `P-OPS-01`, widened by `P-OPS-03`, `P-OPS-04`, `P-OPS-05`, `P-OPS-06`, `P-OPS-07`, `P-OPS-13`, `P-OPS-15`, `P-OPS-21`, `P-OPS-22`, `P-OPS-23`, and queue-shaped by `P-OPS-24`.
...
- `scripts/operational_product_samples.py`: orchestration helper around the `mirrorea-alpha` command family; `run-sugoroku` and `check-all` export machine-readable `sugoroku_scope`, and `check-all` also exports `room_chat_scope`, `portal_shard_starter_scope`, `widening_queue_scope`, and `user_final_decision_scope`
