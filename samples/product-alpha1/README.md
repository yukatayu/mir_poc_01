...
- `P-OPS-24` adds helper-reported `widening_queue_scope`; current room-chat reopening and portal/shard starter reopening remain non-promoted, and `broader_sugoroku_reopening` becomes the next promoted comparison.
