...
- This root currently claims local same-session runtime/save/transport/viewer first-cut behavior, not product alpha release readiness.
- This root does not claim native bundle, WAN/federation, distributed durable save/load R3/R4, final public viewer / telemetry ABI, or arbitrary native package execution.
