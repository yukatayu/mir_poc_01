...
- `hands-on docs / closeout` も close し、avatar representative slice も active にし、hot-plug helper-local lifecycle canary も actualize したので、次の package は transport `NET-02..05`、その後 avatar residual widening です。
