...
- `hands-on docs / closeout` も close し、avatar representative slice も active にし、hot-plug helper-local lifecycle canary と transport helper-local canary も actualize したので、次の package は avatar residual widening、その後 cross-package sweep です。
