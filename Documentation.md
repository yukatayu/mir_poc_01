...
- Surface Mir brace parser floor plus indexed-state semantic checker, Surface-to-Core elaboration, generated communication, and role-admission evidence floors, with `P-SURF-06 source patch hot-plug` as the next promoted package
...
- Surface Mir runtime / helper implementation beyond the P-SURF-05 role-admission report-level evidence floor
