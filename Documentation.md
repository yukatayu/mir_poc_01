...
`specs/examples/556...557` は、
phase6 parser second-tranche first-package close と first strong typing layer finite-index spine default を source-backed に同期する current anchor である。
