...
9. shared-space / membership / authoritative room の docs-first boundary を先に掴みたいときは `plan/16-shared-space-membership-and-example-boundary.md`、`specs/examples/121-shared-space-authoritative-room-baseline.md`、`specs/examples/122-shared-space-catalog-working-subset-comparison.md`、`specs/examples/123-shared-space-auditable-authority-witness-minimal-shape.md`、`specs/examples/124-shared-space-authoritative-room-delegated-rng-provider-placement.md`
