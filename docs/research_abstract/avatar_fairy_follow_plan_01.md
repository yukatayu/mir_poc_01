...
## 3. active representative slice と residual planned family
...
ただし、2026-04-27 の repo-local boundary reading では、
...
repo-local active line は `samples/clean-near-end/` であり、
