...
までは actual external contract として足してよい。ただし consumer-specific external contract payload は still 後段に残す。
...
- actual external contract の次段として consumer-specific external contract payload をどの field で切るか
