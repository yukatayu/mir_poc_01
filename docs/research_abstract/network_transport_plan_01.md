...
loopback / process boundary / reconnect / typed failure / redacted route trace へ安全に広げるための docs-first boundary plan です。
...
2026-04-27 cut では、`NET-01` を helper-local `--transport loopback_socket` preview として actualizeし、
