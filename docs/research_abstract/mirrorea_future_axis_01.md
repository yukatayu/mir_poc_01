...
1. post-`P18` true user-spec hold line
   - packaging / installed binary / FFI / engine adapter / final shared-space operational catalog の actual commitment を user choice として reopen する
2. `P18` repo-side first cut memory
