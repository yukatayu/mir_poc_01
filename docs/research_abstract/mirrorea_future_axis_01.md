...
2026-04-29 時点で repo が実装済みの current line は次です。
...
separate lane で読めるようにしています。2026-04-29 時点では helper/runtime `message_envelope_scope`、
...
2026-04-29 時点では、`plan/20-projection-and-placement-roadmap.md` に
...
2026-04-29 時点では、`plan/21-hotplug-attachpoint-roadmap.md` に
...
2026-04-29 時点では、`plan/22-network-transport-roadmap.md` に
...
2026-04-29 時点では、`plan/23-compiler-backend-llvm-guardrail-roadmap.md` に
