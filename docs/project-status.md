...
| 現在の境界 | P109 は G0 exit を適用せず、オーナー判断待ちで閉じた。 | `plan/153-g0-closeout-evidence-and-exit-decision-packet.md` |

## 現在の停止線

- `plan/153-g0-closeout-evidence-and-exit-decision-packet.md` の
  owner-decision boundary で止まる。
- G0 exit、T1 entry、OBL completion、proof、`mir-conform` 結果、runtime /
  product readiness をこの文書や LAB evidence だけで主張しない。
- 次の自律 successor package を勝手に昇格しない。
- 再開候補は、下表の owner decision が記録された場合、または引用済み根拠に
  具体的な drift が見つかり bounded scope を明示できる場合に限る。

## オーナーの確認・判断待ち

| ID | 必要な確認・判断 | 決定者 | 詳細 |
| --- | --- | --- | --- |
| G0-D1 | ADR、GLOSSARY、LAB-demotion evidence を G0 factual criteria として accept / defer する。 | owner / canon process | `plan/153-g0-closeout-evidence-and-exit-decision-packet.md` |
| G0-D2 | G0-EXIT-001: 非実行 T0 の `mir-conform` JSON 条件をどう canon-compatible に扱うか決める。 | owner / canon process | `plan/153-g0-closeout-evidence-and-exit-decision-packet.md` |
...
| G0-D4 | semantic / historical LAB-demotion audit を追加要求するか決める。 | owner | `plan/153-g0-closeout-evidence-and-exit-decision-packet.md` |
