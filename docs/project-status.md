...
| 5 | value / occurrence | P017 X1 relation-state envelope | X1 は記録済み。WRK-0040 は五つの collapse、WRK-0041 は owner-terminal overlap、WRK-0042 は owner-negative/mutation overlap を supplied fixture 上で検出した。unique pending binding、branch / mutation representation、authority、save/load、observation の positive schema/rule/proof は未選択 |
