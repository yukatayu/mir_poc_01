...
| 実装 / 運用 | alpha / Surface / operational roots は限定 LAB evidence。Full System V1 の committed generated evidence は実行時に書き換えず fresh report と比較し、release bundle は C-distributed conformance / 実 transport / multi-process execution を非主張とする。conformance、実 transport、分散永続、public product は未主張。 | `samples_progress.md`; `scripts/README.md`; `mirrorea_canon/plan/01-phases.md` |
