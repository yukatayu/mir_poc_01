...
- Oracle の independent review と local source check により、WRK-0028 は common
  ...
  question labels の documentary non-substitution だけを retained した。次の自走は
  C0-C/C0-D、C1、C2-B、C6 の bounded candidate re-screen、続いて candidate-local
...
source-tagged documentary non-substitution だけを retained しました。次は C0-C/C0-D、
C1、C2-B、C6 の bounded candidate re-screen と composition/falsifier research を経て、
