...
- `plan/11-roadmap-near-term.md`、`plan/17-research-phases-and-autonomy-gates.md` を確認し、current desired order と既に整合していることを確認した。
- `plan/` の追加更新は不要と判断した。
...
- `plan/11` / `plan/17` は、この順番に関しては追加修正なしで current snapshot と両立していた。
