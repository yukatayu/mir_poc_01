...
| `mir_computational_core_01.md` | current `AddOne` を host-boundary evidence に限定しつつ、`P-COMP-01` planned-only computational scaffold の helper / matrix / rejected-run surface を読む入口 |
