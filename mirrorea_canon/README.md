...
- active I3 bounded program: `meta/proposals/PROPOSAL-037-mirrorea-i3-distributed-foundation.md` →
  ...
  `adr/ADR-0039.md` → `meta/proposals/PROPOSAL-043-mirrorea-i3-program-resume.md` → `adr/ADR-0040.md` → `architecture/10-i3-multi-process-runtime.md` → `architecture/01-strata.md` →
