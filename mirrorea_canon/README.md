...
- active Mirrorea I2 Systems Foundation: `adr/ADR-0026.md` →
  ...
  `adr/ADR-0030.md` → `spec/12-sys3-per-locus-projection.md` →
  `spec/13-sys4-in-process-generated-dispatch.md` → `plan/02-operating-model.md` →
