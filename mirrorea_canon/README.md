...
- active I3 bounded program: `meta/proposals/PROPOSAL-037-mirrorea-i3-distributed-foundation.md` →
  ...
  `adr/ADR-0035.md` → `architecture/01-strata.md` →
  `architecture/06-project-product-layers.md` → `plan/05-i3-entry-contract.md` →
