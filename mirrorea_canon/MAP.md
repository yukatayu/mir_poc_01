...
NORTH-STAR (軸)
   │
   ▼
adr/ (決定 ADR-0001..0017) ◄──── GLOSSARY (概念 CON-###)
   │
   ▼
...
Mir Theory v0 / I1+ Milestones 0--10 の current execution は ADR-0015--0020、
PROPOSAL-018--023 を追加で読み、LAB の designated current roadmap と derived status
