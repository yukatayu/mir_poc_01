...
| WRK-0044 | L3-open, unexecuted | P017 X1 の V1/R1 cross-locus read に限り、external rejection/no-observation を候補仮説とする candidate-local minimum relation-envelope presentation が全 preregistered integration row を reserved surface なしに検査できるかを調べる。Canon schema、transition、identity、proof、runtime は定義・選択しない。`working/WRK-0044-p017-x1-minimum-relation-envelope-coherence.md` |
