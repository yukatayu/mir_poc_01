...
| WRK-0028 | L3-open, not-promoted | Plan 200 の C0/C2 pre-enumerated source span を current Canon cut で literal に転記し、operative fact と bounded proposal direction を source 自身の authority language だけから区別できるかを検査する。意味論の合成・選択はしない。`working/WRK-0028-r0-common-cut-fact-manifest.md` |
