...
| WRK-0043 | L3-open, not-promoted, unexecuted | P017 X1 の V1/R1 cross-locus read に限り、source-named M1 adverse condition の supplied fixture tag と owner-mutation fact が同時に成立する collapse を predicate-only 有限 countermodel で検査する。validation/failure semantics、mutation rule、transition、carrier、runtime は定義・選択しない。`working/WRK-0043-p017-x1-m1-adverse-mutation-countermodel.md` |
