...
| WRK-0034 | L3-open, not-promoted | Plan 203 の WRK-0033 fixed presentation を変えず、opaque LAB reply の arbitrary finite list に対する translation-preservation と local-observation equality だけを conditional lemma として検査する。Mir trace、pending/request/occurrence identity、Core/history/runtime、source inference は定義・選択しない。`working/WRK-0034-v1r1-finite-sequence-refinement.md` |
