...
| WRK-0030 | L3-open | Plan 200 C2-A の request/authority/occurrence/replay wording を WRK-local question label で source-tag し、label 間の documentary non-substitution を検査する。semantic vocabulary、field partition、identity、binding、attempt、replay classifier は選ばない。`working/WRK-0030-c2a-source-tagged-anti-collapse-vocabulary.md` |
