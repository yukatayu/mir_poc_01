...
| WRK-0042 | L3-open | P017 X1 の V1/R1 cross-locus read に限り、supplied fixture の owner-terminal-negative fact と owner-mutation fact が同時に成立する collapse を predicate-only finite countermodel で検査する。failure semantics、mutation rule、transition、carrier、runtime は定義・選択しない。`working/WRK-0042-p017-x1-owner-negative-mutation-countermodel.md` |
