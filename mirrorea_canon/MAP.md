...
| WRK-0038 | L3-open, not-promoted | C2-B/C3 の Canon carrier を選ばず、WRK-0037 の同一二原子有限表で bundled DirectView と independently stated relation-first presentation の観測・遷移保存を比較する。identity、authority、persistence、source rule、runtime は定義・選択しない。`working/WRK-0038-c2b-c3-bundled-relational-presentation.md` |
| WRK-0039 | L3-open, not-promoted | C2-B/C3 の Canon carrier を選ばず、WRK-0037 の全十 supplied key ごとに independently enumerated relation graph と bundled lookup の fiberwise translation を比較する。key recovery、identity、authority、persistence、source rule、runtime は定義・選択しない。`working/WRK-0039-c2b-c3-fiberwise-relational-presentation.md` |
