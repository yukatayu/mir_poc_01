...
| WRK-0032 | L3-open | Plan 201 C5-PRE の pre-enumerated ordinary-admission source span に、verdict から独立した issuance phase を示す literal wording があるかを source-local に記録する。A2 atomicity/facet/compatibility、occurrence identity、Core/history/runtime は選ばない。`working/WRK-0032-c5pre-ordinary-admission-issuance-guard.md` |
