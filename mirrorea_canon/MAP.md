...
| WRK-0046 | L3-open, not-promoted, unexecuted | P017 X1 K0 external-rejection branch に限り、opaque per-state `AcceptedSuccess` と disposable q-fibered `Spent` が一つの finite linear experimental lineage で restore preservation を満たすとき、at-most-one counted consume を条件付きで導けるかを source-free に事前登録した。WRK-0045 の修復ではなく、Canon state/identity/transition/persistence、receipt、Core、proof、runtime は定義・選択しない。`working/WRK-0046-p017-x1-k0-qf-ul-lift.md` |
