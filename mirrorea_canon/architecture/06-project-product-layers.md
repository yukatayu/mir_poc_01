...
status: L1-fixed
maturity: reviewed
depends_on: [root/north-star, root/design-constitution, arch/01-strata, arch/02-boundary-contracts, arch/05-satellites, adr/ADR-0034, adr/ADR-0035, adr/ADR-0040, plan/01-phases]
...
| real process/transport execution | `S4` realized over `S6` | `PL-2` over `PL-0` | bounded I3-2 evidence accepted; I3-3 active under ADR-0040; official I3 lifecycle unentered |
