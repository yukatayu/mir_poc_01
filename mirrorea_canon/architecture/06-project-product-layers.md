...
| real process/transport execution | `S4` realized over `S6` | `PL-2` over `PL-0` | bounded I3-2 evidence accepted; program execution owner-paused; official I3 lifecycle unentered |
