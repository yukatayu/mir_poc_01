...
1. **Mirrorea I3 Distributed Foundation** follows ADR-0034 and
   ...
   is its sole current roadmap. ALIGN-0/1/2 and I3-0/1/2/3 are completed under
   the accepted cuts through ADR-0043. Execution is owner-paused with no active
   semantic milestone. I3-4 requires explicit resume; later milestones remain inactive.
...
I3-2; ADR-0040 resumed I3-3. ADR-0043 applies the owner pause again after I3-3 acceptance.
