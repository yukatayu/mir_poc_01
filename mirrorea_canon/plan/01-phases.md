...
- implementation evidence: **M10 accepted; official I2 entry then exit accepted;
  SYS-0--SYS-7 / ADR-0026 program closed; ADR-0034 / Plan 250 active at ALIGN-2
  after ALIGN-1 close**。architecture/04 の full L2 carrier freeze と OPEN-026/027 が
...
PROPOSAL-038 / ADR-0035はALIGN-1をcloseした。ALIGN-0/1 completed、ALIGN-2 activeで
ある。これはofficial I3 entry/exitではない。official I2 exitを維持し、
