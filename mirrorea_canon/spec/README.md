...
status: L1-fixed
maturity: draft
depends_on: [theory/readme, adr/ADR-0008, adr/ADR-0009, adr/ADR-0021, adr/ADR-0022, adr/ADR-0023, adr/ADR-0024, adr/ADR-0025, adr/ADR-0029, adr/ADR-0030, adr/ADR-0031, adr/ADR-0032]
...
03 M6 静的分類 → 04 M6 CoreTemplate → 08 M7 checked elaboration → 09 M8 deterministic runtime → 10 M9 auth/verification → 11 M10 I1+ conformance →
12 SYS-3 bounded designated-consume + checked-Core per-locus projection →
...
17 I3-3 read-only provider effect / typed host crossing契約（実装受理ではない） →
