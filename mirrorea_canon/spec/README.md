...
status: L1-fixed
maturity: draft
depends_on: [theory/readme, adr/ADR-0008, adr/ADR-0009, adr/ADR-0021, adr/ADR-0022, adr/ADR-0023]
...
03 M6 静的分類 → 04 M6 CoreTemplate → 08 M7 checked elaboration → 09 M8 deterministic runtime →
