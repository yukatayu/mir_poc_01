...
status: L1-fixed
maturity: draft
depends_on: [root/readme, adr/ADR-0014, adr/ADR-0015, adr/ADR-0026, adr/ADR-0033, adr/ADR-0034, adr/ADR-0039, adr/ADR-0040]
...
resumeを記録したADR-0040により、現在はI3-3のみactiveとする。program外でADR-0014 の route によりL2/L3 working theoryを更新するとき、update surface は
