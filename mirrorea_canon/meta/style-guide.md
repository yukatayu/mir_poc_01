...
status: L1-fixed
maturity: draft
depends_on: [root/readme, adr/ADR-0014, adr/ADR-0015, adr/ADR-0026, adr/ADR-0033, adr/ADR-0034, adr/ADR-0039, adr/ADR-0040, adr/ADR-0043]
summary: 執筆規約。front matter schema、ID、claim、bounded program pause/resume と通常 route の改定手続き。
open_items: []
---
...
resumeを記録したADR-0040の後、ADR-0043はI3-3を受理して再びowner pauseを適用した。現在はactive semantic milestoneなし、I3-4はexplicit resumeまでinactiveである。program外でADR-0014 の route によりL2/L3 working theoryを更新するとき、update surface は
