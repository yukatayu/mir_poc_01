...
00 見取り図(意味層と 4 グラフ) → 01 MirCore v0(構文・統合判定・操作意味論) → 02 型・効果・失敗 → 03 elaboration(THM-001) → 04 順序と cut → 05 権限 → 06 存在と fallback → 07 観測 → 08 patch → 09 二層時間 → 10 診断 → 11 定理・義務台帳 → 12 文献。
