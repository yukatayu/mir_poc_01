...
status: L1-fixed
maturity: draft
depends_on: [theory/03-elaboration, theory/10-diagnostics, theory/13-evaluation-materialization, theory/14-maintained-relation-projection, theory/15-shared-formal-model, adr/ADR-0022]
summary: M6 fixed source classificationを有限検査し、deterministic checked elaboration・義務・residualを返すM7境界。
open_items: []
---
...
relation, designated, auth, and verify spans; each entry has a stable ordinal
...
publication or consumer semantic mutation.
