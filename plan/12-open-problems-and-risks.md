...
- current remaining risk は、saved artifact compare need が shared carrier threshold を本当に満たすか、later generic structural checker family comparison で `disallowed_fallback_placement` をどう generalize するか、である
