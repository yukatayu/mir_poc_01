...
- 何を semantic carrier / checker boundary / source-visible first candidate として扱うか。
- current reading:
  **boundary inventory は進められるが、full type system へ飛ぶ段階ではない。**

### 2. theorem pilot order

- semantic core のどの invariant family から theorem-side pilot を始めるか。
- current reading:
  **semantic-core theorem pilot planning は十分進められる。**
...
- current reading:
  **theory-first inventory と adequacy corpus は進められるが、source surface adoption はまだ早い。**
