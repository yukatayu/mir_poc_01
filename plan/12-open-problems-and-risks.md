...
- current Phase 5 checker-side line では、これらの typed reason family を cluster row core へ immediate に混ぜず、`specs/examples/257...258` の判断どおり、minimal checker-cluster row core と `fixture_evidence_refs` attachment を先に切る方が自然である
