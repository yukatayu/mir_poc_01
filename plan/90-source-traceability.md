...
| plan | 主な根拠 source |
|---|---|
| `plan/01-status-at-a-glance.md` | `Documentation.md`、`progress.md`、`tasks.md`、`specs/10-open-questions.md`、`specs/11-roadmap-and-workstreams.md`、`specs/12-decision-register.md`、`docs/reports/0904-*` |
...
current active traceability の正本は clean near-end suite と 2026-04-22 closeout report である。
