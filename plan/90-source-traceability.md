...
| `plan/17-research-phases-and-autonomy-gates.md` | `progress.md`、`tasks.md`、`samples_progress.md`、`plan/11-roadmap-near-term.md`、`docs/research_abstract/avatar_fairy_follow_plan_01.md`、`sub-agent-pro/mirrorea_future_plan_full_handoff_2026-04-24.md`、`sub-agent-pro/mirrorea_phase_samples_progress_storage_handoff_2026-04-24.md`、`docs/reports/0912-*`、`docs/reports/0913-*`、`docs/reports/0916-*`、`docs/reports/0917-*` |
