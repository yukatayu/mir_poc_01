...
- `Vocab`: abstract types for environment, context, locus, judgment input,
  ...
  bindings, diagnostic family, missing evidence kind, span, association key,
  diagnostic branch, and replay witness;
...
family / missing evidence / span / replay witnesses such that:
