...
- したがって current next pressure は low-level memory-order の即時導入ではなく、retention state / actual retained path policy / emitted artifact threshold を narrow に比較することである。
