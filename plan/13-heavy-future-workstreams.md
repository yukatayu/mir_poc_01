...
- したがって current next pressure は low-level memory-order の即時導入ではなく、concrete theorem consumer class と consumer-specific attachment family をどこまで narrow に比べるかを比較することである。
