...
- したがって current next pressure は low-level memory-order の即時導入そのものではなく、minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison を narrow に比較することである。
