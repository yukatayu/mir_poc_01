...
- したがって current next pressure は low-level memory-order の即時導入そのものではなく、minimal-handoff-witness-row-detail-ready replay-attachment-ref comparison を narrow に比較することである。
