...
- したがって current next pressure は low-level memory-order の即時導入そのものではなく、authority-serial-transition-family-ready authority-serial-transition-contract comparison を narrow に比較することである。
