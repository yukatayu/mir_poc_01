...
- したがって current next pressure は low-level memory-order の即時導入そのものではなく、minimal-handoff-payload-ref-ready handoff-carrier-detail comparison を narrow に比較することである。
