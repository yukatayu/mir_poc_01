...
- したがって current next pressure は low-level memory-order の即時導入ではなく、どの external consumer が first actual handoff pressure になるか、そこで boundary-specific split が本当に必要かを narrow に比較することである。
