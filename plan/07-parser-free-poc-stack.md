...
- 次の narrow question は、predicate fragment helper の malformed-source pair を先に actualize するか、それとも request head + clause attachment multiline shape の docs-only comparison を先に開くかである
