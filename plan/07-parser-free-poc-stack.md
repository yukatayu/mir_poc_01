...
- したがって次段 actualization は、request head / option body の full parse ではなく、multiline block extraction を helper-local / test-only source carrier compare にどこまで actualize するかを narrow に切るのが自然である
