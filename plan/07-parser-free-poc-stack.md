...
- current next-step sequencing としては、request-local clause suite completion を先に比較するか、multiline attachment malformed-source pair をもう 1 段増やすかを narrow に比較するのが自然である
