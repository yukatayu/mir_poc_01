...
6. directory-level の差を見たいときは `emit-aggregate` のあと `compare-aggregates` で `summary_core` を比較する
7. 1 command でまとめたいときは `scripts/current_l2_detached_loop.py smoke-fixture` を non-production convenience として使ってよい
