...
- 現在地: `specs/examples/126...244` までで theorem-line later package close、**next promoted line は minimal-handoff-carrier-detail-ready handoff-transport-family comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-handoff-carrier-detail-ready handoff-transport-family comparison** と読むのが自然である。
