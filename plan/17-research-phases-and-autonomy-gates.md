...
- 現在地: `specs/examples/126...207` までで theorem-line later package close、**next promoted line は theorem-export-checker-payload-ready checker-result-materialization-family comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - theorem-export-checker-payload-ready checker-result-materialization-family comparison
...
- **current promoted line は Phase 5 theorem-export-checker-payload-ready checker-result-materialization-family comparison** と読むのが自然である。
