...
- 現在地: `specs/examples/126...194` までで theorem-line later package close、**next promoted line は boundary-specific-handoff-pair-ready actual handoff pair shape comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - boundary-specific-handoff-pair-ready actual handoff pair shape comparison
...
- **current promoted line は Phase 5 boundary-specific-handoff-pair-ready actual handoff pair shape comparison** と読むのが自然である。
