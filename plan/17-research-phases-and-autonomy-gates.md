...
- 現在地: `specs/examples/126...208` までで theorem-line later package close、**next promoted line は actual-exported-checker-payload-ready actual-checker-result-payload comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - actual-exported-checker-payload-ready actual-checker-result-payload comparison
...
- **current promoted line は Phase 5 actual-exported-checker-payload-ready actual-checker-result-payload comparison** と読むのが自然である。
