...
- 現在地: `specs/examples/126...205` までで theorem-line later package close、**next promoted line は theorem-export-checker-contract-ready exported-checker-payload-pressure comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - theorem-export-checker-contract-ready exported-checker-payload-pressure comparison
...
- **current promoted line は Phase 5 theorem-export-checker-contract-ready exported-checker-payload-pressure comparison** と読むのが自然である。
