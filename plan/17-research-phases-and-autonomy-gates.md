...
- 現在地: `specs/examples/126...280` までで current package close、**next promoted line は minimal-public-checker-command-surface-ready shared-output-contract comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-public-checker-command-surface-ready shared-output-contract comparison** と読むのが自然である。
