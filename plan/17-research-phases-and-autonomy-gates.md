...
1. **Phase 6 parser second tranche attached-slot / predicate-fragment first package**
   - admit-slot / predicate route の最小 cut を actualize する
...
2. **Phase 6 reserve formal tool binding inventory** を narrow に行う
...
- **current immediate line は Phase 6 parser second tranche attached-slot / predicate-fragment first package** と読むのが自然である。
