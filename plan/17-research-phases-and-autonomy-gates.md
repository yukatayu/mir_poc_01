...
- 現在地: `specs/examples/126...213` までで theorem-line later package close、**next promoted line は checker-verdict-transport-family-ready checker-verdict-transport-carrier-detail comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - checker-verdict-transport-family-ready checker-verdict-transport-carrier-detail comparison
...
- **current promoted line は Phase 5 checker-verdict-transport-family-ready checker-verdict-transport-carrier-detail comparison** と読むのが自然である。
