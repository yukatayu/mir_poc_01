...
- 現在地: `specs/examples/126...232` までで theorem-line later package close、**next promoted line は minimal-authority-stage-local-obligation-row-detail-ready authority-handoff-epoch-ref comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-authority-stage-local-obligation-row-detail-ready authority-handoff-epoch-ref comparison** と読むのが自然である。
