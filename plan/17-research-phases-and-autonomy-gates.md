...
- 現在地: `specs/examples/126...195` までで theorem-line later package close、**next promoted line は actual-handoff-pair-shape-ready boundary-specific handoff artifact row comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - actual-handoff-pair-shape-ready boundary-specific handoff artifact row comparison
...
- **current promoted line は Phase 5 actual-handoff-pair-shape-ready boundary-specific handoff artifact row comparison** と読むのが自然である。
