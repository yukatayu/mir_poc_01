...
- 現在地: `specs/examples/126...192` までで theorem-line later package close、**next promoted line は strict dual-field ready consumer-visible pair comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - strict dual-field ready consumer-visible pair comparison
...
- **current promoted line は Phase 5 strict dual-field ready consumer-visible pair comparison** と読むのが自然である。
