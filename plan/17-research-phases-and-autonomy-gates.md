...
- 現在地: `specs/examples/126...252` までで theorem-line later package close、**next promoted line は minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison** と読むのが自然である。
