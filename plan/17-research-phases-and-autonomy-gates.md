...
- 現在地: `specs/examples/126...203` までで theorem-line later package close、**next promoted line は proof-assistant-adapter-contract-ready theorem-export-checker-pressure comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - proof-assistant-adapter-contract-ready theorem-export-checker-pressure comparison
...
- **current promoted line は Phase 5 proof-assistant-adapter-contract-ready theorem-export-checker-pressure comparison** と読むのが自然である。
