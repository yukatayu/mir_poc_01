...
- 現在地: `specs/examples/126...272` までで current package close、**next promoted line は minimal-checker-payload-supported-kind-summary-ready public-checker-payload-schema comparison**
- 重さ: とても重い
- autonomy gate:
...
- Phase 5 checker-cluster matrix line の docs-first comparison
...
- **current promoted line は Phase 5 minimal-checker-payload-supported-kind-summary-ready public-checker-payload-schema comparison** と読むのが自然である。
