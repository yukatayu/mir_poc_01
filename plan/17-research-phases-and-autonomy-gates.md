...
- 現在地: parser / checker-runtime / tool-neutral formal-hook / proof-notebook review-unit pilot / `e1` actualization fixed
- 重さ: 重い
- autonomy gate:
...
- **current immediate line は Phase 6 second widened authored row actualization** と読むのが自然である。
