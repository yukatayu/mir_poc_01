...
1. `Macro 4` stable malformed capability second reopen actualization comparison

## current reserve line

- `Macro 7` public operational CLI concrete shell naming
