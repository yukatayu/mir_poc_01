...
1. **Phase 6 syntax-backed sample runner first cut**
...
3. **Phase 6 source-sample authoring / bless policy**
   - source sample の practical 更新手順と drift suppression を固定する
...
2. **Phase 6 verification ladder / source-sample policy** を narrow に行う
3. **Phase 6 source-sample authoring / bless policy** を narrow に行う
...
- Phase 6 source-sample authoring / bless policy
...
- **current immediate line は Phase 6 syntax-backed sample runner first cut** と読むのが自然である。
