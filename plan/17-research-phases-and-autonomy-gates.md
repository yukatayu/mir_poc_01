...
- 現在地: `specs/examples/126...246` までで theorem-line later package close、**next promoted line は minimal-handoff-transport-family-ready handoff-transport-carrier-detail comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-handoff-transport-family-ready handoff-transport-carrier-detail comparison** と読むのが自然である。
