...
- 現在地: `specs/examples/126...196` までで theorem-line later package close、**next promoted line は boundary-specific-handoff-artifact-row-ready external-contract-facing handoff row comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - boundary-specific-handoff-artifact-row-ready external-contract-facing handoff row comparison
...
- **current promoted line は Phase 5 boundary-specific-handoff-artifact-row-ready external-contract-facing handoff row comparison** と読むのが自然である。
