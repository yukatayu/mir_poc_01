...
- 現在地: `specs/examples/126...270` までで current package close、**next promoted line は minimal-checker-payload-row-body-ready checker-payload-supported-kind-summary comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-checker-payload-row-body-ready checker-payload-supported-kind-summary comparison** と読むのが自然である。
