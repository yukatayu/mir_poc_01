...
- 現在地: `specs/examples/126...236` までで theorem-line later package close、**next promoted line は minimal-witness-aware-handoff-family-ready handoff-witness-row-detail comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-witness-aware-handoff-family-ready handoff-witness-row-detail comparison** と読むのが自然である。
