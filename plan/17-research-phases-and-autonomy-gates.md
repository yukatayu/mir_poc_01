...
- 現在地: `specs/examples/126...186` までで theorem-line later package close、**next promoted line は actual retained payload body materialization carrier payload comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - actual retained payload body materialization carrier payload comparison
...
- **current promoted line は Phase 5 actual retained payload body materialization carrier payload comparison** と読むのが自然である。
