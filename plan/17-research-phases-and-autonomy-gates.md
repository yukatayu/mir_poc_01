...
- 現在地: `specs/examples/126...234` までで theorem-line later package close、**next promoted line は minimal-authority-handoff-epoch-ref-ready witness-aware-handoff-family comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-authority-handoff-epoch-ref-ready witness-aware-handoff-family comparison** と読むのが自然である。
