...
- 現在地: `specs/examples/126...201` までで theorem-line later package close、**next promoted line は consumer-hint-ready second-consumer-pressure comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - consumer-hint-ready second-consumer-pressure comparison
...
- **current promoted line は Phase 5 consumer-hint-ready second-consumer-pressure comparison** と読むのが自然である。
