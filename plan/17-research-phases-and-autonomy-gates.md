...
- 現在地: `specs/examples/126...254` までで theorem-line later package close、**next promoted line は minimal-handoff-transport-channel-body-ready low-level-memory-order-family comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-handoff-transport-channel-body-ready low-level-memory-order-family comparison** と読むのが自然である。
