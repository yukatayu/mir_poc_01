...
1. `Macro 4` stable malformed missing-option first reopen actualization comparison
2. `Macro 7` final public parser / checker / runtime API first later gate actualization comparison
