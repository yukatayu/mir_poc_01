...
- 現在地: `specs/examples/126...278` までで current package close、**next promoted line は minimal-public-checker-entry-criteria-ready public-checker-command-surface comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-public-checker-entry-criteria-ready public-checker-command-surface comparison** と読むのが自然である。
