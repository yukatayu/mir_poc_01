...
- Mirrorea/shared-space docs-first re-entry bundle は fixed 済みであり、current mainline は再び `Macro 5` / `Macro 4` 側へ戻りつつ、Macro 6 の next docs-first reopen を reserve に保持している。
