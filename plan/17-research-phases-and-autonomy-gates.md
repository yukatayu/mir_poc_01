...
- 現在地: `specs/examples/126...197` までで theorem-line later package close、**next promoted line は external-contract-facing-handoff-row-ready actual external contract comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - external-contract-facing-handoff-row-ready actual external contract comparison
...
- **current promoted line は Phase 5 external-contract-facing-handoff-row-ready actual external contract comparison** と読むのが自然である。
