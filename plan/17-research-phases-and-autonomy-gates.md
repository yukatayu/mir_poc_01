...
- 現在地: `specs/examples/126...200` までで theorem-line later package close、**next promoted line は proof-hint-ready consumer-hint / second-consumer-pressure comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - proof-hint-ready consumer-hint / second-consumer-pressure comparison
...
- **current promoted line は Phase 5 proof-hint-ready consumer-hint / second-consumer-pressure comparison** と読むのが自然である。
