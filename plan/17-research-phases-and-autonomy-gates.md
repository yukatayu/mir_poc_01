...
- 現在地: `specs/examples/126...228` までで theorem-line later package close、**next promoted line は minimal-authority-transition-stage-sequence-ready stage-local-obligation-family comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-authority-transition-stage-sequence-ready stage-local-obligation-family comparison** と読むのが自然である。
