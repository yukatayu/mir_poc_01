...
- 現在地: `specs/examples/126...276` までで current package close、**next promoted line は minimal-public-checker-api-ready public-checker-entry-criteria comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-public-checker-api-ready public-checker-entry-criteria comparison** と読むのが自然である。
