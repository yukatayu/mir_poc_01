...
- 現在地: `specs/examples/126...211` までで theorem-line later package close、**next promoted line は checker-verdict-payload-family-ready checker-verdict-witness-family comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 checker-verdict-payload-family-ready checker-verdict-witness-family comparison** と読むのが自然である。
