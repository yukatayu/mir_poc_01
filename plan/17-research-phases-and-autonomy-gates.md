...
- 現在地: `specs/examples/126...180` までで theorem-line later package close、**next promoted line は archive retention layout comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - archive retention layout comparison
...
- **current promoted line は Phase 5 archive retention layout comparison** と読むのが自然である。
