...
- 現在地: `specs/examples/126...230` までで theorem-line later package close、**next promoted line は minimal-authority-stage-local-obligation-family-ready stage-local-obligation-row-detail comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-authority-stage-local-obligation-family-ready stage-local-obligation-row-detail comparison** と読むのが自然である。
