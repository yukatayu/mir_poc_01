...
- 現在地: `specs/examples/126...238` までで theorem-line later package close、**next promoted line は minimal-handoff-witness-row-detail-ready replay-attachment-ref comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-handoff-witness-row-detail-ready replay-attachment-ref comparison** と読むのが自然である。
