...
- 現在地: `specs/examples/126...274` までで current package close、**next promoted line は minimal-public-checker-payload-schema-ready public-checker-api comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-public-checker-payload-schema-ready public-checker-api comparison** と読むのが自然である。
