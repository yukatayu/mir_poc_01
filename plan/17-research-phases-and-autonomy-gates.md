...
- 現在地: `specs/examples/126...240` までで theorem-line later package close、**next promoted line は minimal-replay-attachment-ref-ready handoff-payload-ref comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-replay-attachment-ref-ready handoff-payload-ref comparison** と読むのが自然である。
