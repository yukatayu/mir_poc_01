...
1. `Macro 7` public operational CLI concrete shell naming comparison

## current reserve line

- `Macro 4` stable malformed capability second source-backed widening actualization comparison
