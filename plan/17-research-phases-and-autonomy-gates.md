...
- 現在地: `specs/examples/126...204` までで theorem-line later package close、**next promoted line は theorem-export-checker-pressure-ready checker-facing contract comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - theorem-export-checker-pressure-ready checker-facing contract comparison
...
- **current promoted line は Phase 5 theorem-export-checker-pressure-ready checker-facing contract comparison** と読むのが自然である。
