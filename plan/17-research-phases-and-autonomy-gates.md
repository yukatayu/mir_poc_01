...
- 現在地: `specs/examples/126...242` までで theorem-line later package close、**next promoted line は minimal-handoff-payload-ref-ready handoff-carrier-detail comparison**
- 重さ: とても重い
- autonomy gate:
...
- **current promoted line は Phase 5 minimal-handoff-payload-ref-ready handoff-carrier-detail comparison** と読むのが自然である。
