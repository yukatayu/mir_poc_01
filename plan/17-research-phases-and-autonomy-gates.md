...
2. `Macro 7` docs-first I/O / host-facing port boundary comparison（working label）
3. `Macro 4` stable malformed missing-option first reopen actualization comparison
