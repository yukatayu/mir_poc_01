...
- 現在地: `specs/examples/126...190` までで theorem-line later package close、**next promoted line は actual bless-side row / update-side row dual-ref comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - actual bless-side row / update-side row dual-ref comparison
...
- **current promoted line は Phase 5 actual bless-side row / update-side row dual-ref comparison** と読むのが自然である。
