...
- 現在地: `specs/examples/126...209` までで theorem-line later package close、**next promoted line は checker-result-materialization-family-ready checker-verdict-carrier-detail comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - checker-result-materialization-family-ready checker-verdict-carrier-detail comparison
...
- **current promoted line は Phase 5 checker-result-materialization-family-ready checker-verdict-carrier-detail comparison** と読むのが自然である。
