...
2. **sequencing judgment の first execution package**
   - Task 1 で選ばれた reopen line の最小 cut を actualize する
...
2. **sequencing judgment の first execution package** を narrow に行う
...
- **current immediate line は Phase 6 next reopen sequencing** と読むのが自然である。
