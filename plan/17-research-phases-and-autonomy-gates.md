...
1. `Macro 4` stable malformed missing-option first source-backed widening actualization

## current reserve line

- `Macro 7` public operational CLI second later gate actualization comparison
- `Macro 7` final public parser / checker / runtime thin-facade later support actualization
