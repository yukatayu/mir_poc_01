...
- 現在地: `specs/examples/126...198` までで theorem-line later package close、**next promoted line は actual-external-contract-ready consumer-specific external contract payload comparison**
- 重さ: とても重い
- autonomy gate:
...
1. **Phase 5 later reopen の current promoted line**
   - actual-external-contract-ready consumer-specific external contract payload comparison
...
- **current promoted line は Phase 5 actual-external-contract-ready consumer-specific external contract payload comparison** と読むのが自然である。
