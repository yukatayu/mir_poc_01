...
- Phase 5 は `specs/examples/126...218` までで theorem-line later package close であり、**next promoted line は `checker-verdict-transport-channel-body-ready higher-level-async-control-family comparison`** である。
...
### 1. checker-verdict-transport-channel-body-ready higher-level-async-control-family comparison を Phase 5 later reopen の current promoted line として扱う

- `retained_payload_body_materialization_theorem_export_checker_verdict_transport_channel_body` を theorem-line retained bridge の stop line に維持したまま、higher-level async-control family をどこから比較するかを整理する
- `event_tree_execution_view`、`authority_serial_transition_family`、`witness_aware_commit_family` を first candidates として比べ、low-level memory-order family は still later candidate に残す
- rough weight: 中〜重
...
|---|---|---|
| checker-verdict-transport-channel-body-ready higher-level-async-control-family comparison | 1〜3 task | current promoted line |
