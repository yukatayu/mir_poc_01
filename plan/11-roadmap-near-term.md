...
- next later candidate は、bridge sketch に compare / bless-like review flow metadata をどこまで足すかの comparison であり、actual emitted notebook artifact はさらに後段に残す
- rough weight: 重
