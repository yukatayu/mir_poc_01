...
|---|---|---|
| syntax-backed sample runner + verification ladder | 2〜4 task | fixed subset source sample を runtime / formal line へ段階接続する |
| authoring/bless policy | 1〜2 task | source sample 更新と drift suppression を practical flow にする |
