...
### 2. final public parser/checker/runtime thin-facade later support actualization
...
- `Macro 4`
- missing-option source-backed widening close 後の malformed-side next reopen として、capability family をどこから separate に再開するかを整理する。
