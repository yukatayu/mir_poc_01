...
|---|---|---|---|---|---|
| 1 | `67` checker payload public-schema sketch ratchet | `Macro 5/7` | checker payload supported-kind summary threshold の次段として public checker payload schema sketch をどこまで helper-local summary に近づけるか | `M` | final public checker artifact や final public verifier contract を凍らせず、5 ref wrapper の helper-local preview を整理できる |
...
- current self-driven queue は queue zero ではなく、checker payload public-schema sketch ratchet を含む。
