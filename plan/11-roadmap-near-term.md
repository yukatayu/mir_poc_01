...
|---|---|---|---|---|---|
| 1 | `theorem-first-external-pilot` | `Macro 6/7` | theorem-first external pilot を repo-local emitted-artifact loop の次段で narrow actualization する | `M` | emitted-artifact loop / notebook-first pilot / reopen threshold が reserve lane から問題なく辿れる |
| 2 | `auditable-authority-witness` | `Macro 6` | authoritative-room strengthening line を final public witness schema に上げずに narrow actualization する | `M` | authoritative-room baseline と witness strengthening の差分が helper / docs / scenario loop で追える |
| 3 | `delegated-rng-service` | `Macro 6` | provider placement practical line を first actual default の後段で narrow actualization する | `M` | authority placement と provider placement の差分が helper / docs / scenario loop で追える |
| 4 | `model-check-second-line` | `Macro 5/6` | row-local property carrier second-line を public checker finalization と切り離したまま narrow actualization する | `M` | property carrier / tool seam / public seam residual が problem1 lane と干渉せず追える |
