...
|---|---|---|---|---|---|
| 1 | `60` theorem/model-check residual mixed-gate compression | `Macro 5/7` | theorem/model-check residual mixed gates をどの reopen order で narrow に残すか | `M` | actualized helper preview / representative sample floor を基点に、stale comparison debt を増やさず reopen order を sharpen できる |
| 2 | `61` order-handoff/shared-space residual mixed-gate compression | `Macro 5/6/7` | source wording / emitted-artifact / witness-provider public-contract residual をどの reopen order で narrow に残すか | `M` | edge-row principal と route/schema actual adoption を保ったまま residual order を sharpen できる |
...
- current self-driven queue は queue zero ではなく、residual theorem/model-check compression と residual order-handoff/shared-space compression を含む。
