...
### 1. stable malformed capability second source-backed widening actualization comparison
...
### 2. public operational CLI concrete shell actualization comparison
...
- `Macro 7`
- docs-only naming で fixed した `mir-current-l2 run-source-sample` shell を、actual operational shell concern へどう reopen するかを整理する。
