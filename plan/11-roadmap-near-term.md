...
|---|---|---|---|---|---|
| 1 | `134` parser-side residual closeout sync | `Macro 5/7` | parser-side residual を repo-local once-through closeout line と分離して保つ | `M` | parser-side residual が mixed gate として独立に読める |
| 2 | `135` true user-spec residual freeze sync | `Macro 7/8` | true user-spec residual を explicit hold line に固定する | `S` | user-spec residual が reserve / mixed gate と分離して読める |
...
- current self-driven queue は queue zero ではなく、Package 134 / 135 next closeout / user-spec freeze sync と later mixed/user-spec residual を含む。reserve integration lane は Package 133 summary helper まで actualize 済みである。
