...
- Phase 5 は `specs/examples/126...228` までで theorem-line later package close であり、**next promoted line は `minimal-authority-transition-stage-sequence-ready stage-local-obligation-family comparison`** である。
...
### 1. minimal-authority-transition-stage-sequence-ready stage-local-obligation-family comparison を Phase 5 later reopen の current promoted line として扱う

- `retained_payload_body_materialization_theorem_export_authority_transition_stage_sequence` を current first cut に置いた前提で、stage-local obligation family を theorem-line retained bridge にどこまで近づけるかを整理する
...
|---|---|---|
| minimal-authority-transition-stage-sequence-ready stage-local-obligation-family comparison | 1〜3 task | current promoted line |
