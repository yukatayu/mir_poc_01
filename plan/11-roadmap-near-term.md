...
### 1. minimal-public-checker-command-surface-ready shared-output-contract comparison を Phase 5 の current promoted line として扱う
...
|---|---|---|
| minimal-public-checker-command-surface-ready shared-output-contract comparison | 1〜3 task | current promoted line |
