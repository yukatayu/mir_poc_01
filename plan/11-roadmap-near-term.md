...
- Phase 5 は `specs/examples/126...240` までで theorem-line later package close であり、**next promoted line は `minimal-replay-attachment-ref-ready handoff-payload-ref comparison`** である。
...
### 1. minimal-replay-attachment-ref-ready handoff-payload-ref comparison を Phase 5 later reopen の current promoted line として扱う

- `retained_payload_body_materialization_theorem_export_handoff_replay_attachment_ref` を current first cut に置いた前提で、handoff payload ref を theorem-line retained bridge にどこまで近づけるかを整理する
...
|---|---|---|
| minimal-replay-attachment-ref-ready handoff-payload-ref comparison | 1〜3 task | current promoted line |
