...
|---|---|---|---|---|---|
| 1 | `129` authoritative-room runnable scenario hardening | `Macro 6/7` | authoritative-room first scenario を smoke / emitted artifact / negative pair 付き runnable slice として tighten する | `M` | authoritative-room first scenario が runnable scenario bundle として再確認できる |
...
- current self-driven queue は queue zero ではなく、Package 129 authoritative-room runnable scenario hardening と later mixed/user-spec residual を含む。
