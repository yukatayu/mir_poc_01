...
- Phase 5 は `specs/examples/126...234` までで theorem-line later package close であり、**next promoted line は `minimal-authority-handoff-epoch-ref-ready witness-aware-handoff-family comparison`** である。
...
### 1. minimal-authority-handoff-epoch-ref-ready witness-aware-handoff-family comparison を Phase 5 later reopen の current promoted line として扱う

- `retained_payload_body_materialization_theorem_export_authority_handoff_epoch_ref` を current first cut に置いた前提で、witness-aware handoff family を theorem-line retained bridge にどこまで近づけるかを整理する
...
|---|---|---|
| minimal-authority-handoff-epoch-ref-ready witness-aware-handoff-family comparison | 1〜3 task | current promoted line |
