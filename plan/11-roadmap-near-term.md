...
- next later candidate は、review-linked bless bridge に retained notebook path / review session lifecycle をどこまで足すかの comparison であり、actual emitted notebook artifact はさらに後段に残す
- rough weight: 重
