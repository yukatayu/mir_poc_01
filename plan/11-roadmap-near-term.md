...
|---|---|---|---|---|---|
| 1 | `135` true user-spec residual freeze sync | `Macro 7/8` | true user-spec residual を explicit hold line に固定する | `S` | user-spec residual が reserve / mixed gate と分離して読める |
...
- current self-driven queue は queue zero ではなく、Package 135 next user-spec freeze sync と later mixed/user-spec residual を含む。reserve integration lane と parser-side residual lane は Package 133 / 134 helper まで actualize 済みである。
