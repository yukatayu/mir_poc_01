...
|---|---|---|---|---|---|
| 1 | `132` repo-local once-through closeout sync after executable loops | `Macro 5/6/7` | executable loop 群を踏まえた near-end closeout snapshot を再圧縮する | `M` | queue drift が消え、remaining mixed/user-spec residual が stale wording なしで読める |
