...
- next later candidate は、notebook bridge artifact / stable contract threshold をどこまで narrow に比べるかである
- rough weight: 重
