...
|---|---|---|---|---|---|
| 1 | `106` parser companion mapping matrix | `Macro 6/7` | original prototype / parser companion / guided bundle / Lean artifact / anchor spec-report の対応を drift なく readable にする | `S-M` | representative slice の mapping matrix が docs / helper / traceability の 3 点で同じ読みになる |
...
- current self-driven queue は queue zero ではなく、Package 106 parser-side readable-mapping package と later mixed/user-spec residual を含む。
