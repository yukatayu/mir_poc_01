...
### 2. public operational CLI second later gate actualization comparison
...
- `Macro 7`
- runtime-led thin facade first cut を保ったまま、standalone parser/checker support entry を later public support としてどこまで切るかを整理する。
