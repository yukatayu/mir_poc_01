...
|---|---|---|---|---|---|
| 1 | `115` Problem 1 theorem/model-check mixed-gate split refresh | `Macro 5/7` | Problem 1 remaining mixed gate を typed source principal / theorem public-contract / model-check public-contract の 3 本へ split する | `M` | Problem 1 reopen order と next package が narrow に読める |
| 2 | `116` Problem 2 order-handoff/public-shape mixed-gate split refresh | `Macro 5/6` | Problem 2 remaining mixed gate を source wording / emitted schema と witness-provider public shape の 2 本へ split する | `M` | Problem 2 reopen order と next package が narrow に読める |
...
- current source:
  `specs/examples/588`
- current recommendation:
  reopen-map で aggregate に見える Problem 1 remaining mixed gate を、typed source principal / theorem public-contract / model-check public-contract の separate package へ split する。
- stop line:
  final public theorem contract
...
- current source:
  `specs/examples/588`
- current recommendation:
  reopen-map で aggregate に見える Problem 2 remaining mixed gate を、source wording / emitted schema と witness-provider public shape の separate package へ split する。
- stop line:
  final public witness/provider/artifact contract
  exhaustive shared-space catalog
  final public parser / checker / runtime API
...
- current self-driven queue は queue zero ではなく、Package 115 Problem 1 theorem/model-check mixed-gate split refresh、Package 116 Problem 2 order-handoff/public-shape mixed-gate split refresh と later mixed/user-spec residual を含む。
