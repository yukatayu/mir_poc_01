...
|---|---|---|---|---|---|
| 1 | `126` syntax-modality final-marker lane follow-up | `Macro 5` | final modal foundation / source marker を Problem-local seam と true user-spec residual から切り分けたまま圧縮する | `S` | syntax/modality lane が Problem 1 / Problem 2 / user-spec residual と混ざらず読める |
...
- current self-driven queue は queue zero ではなく、Package 126 syntax-modality final-marker lane follow-up と later mixed/user-spec residual を含む。
