...
- next later candidate は、named review unit を stronger notebook bridge sketch へどこまで拡張するかの comparison であり、compare / bless-like flow は second step に残す
- rough weight: 重
