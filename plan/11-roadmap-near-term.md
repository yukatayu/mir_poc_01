...
- current near-term では、proof/model-check first concrete pilot、second source-sample cluster sequencing、actual `e22` contrast-row source actualizationを fixed entry criteria に閉じたうえで、post-contrast broader cluster と public surface inventory を staged に進める line を優先する。
