...
|---|---|---|---|---|---|
| 1 | `119` Problem 1 model-check public-contract split | `Macro 5/7` | Problem 1 model-check public-contract residual を typed / theorem residual から切り離して narrow にする | `M` | model-check public-contract reopen point が独立 package として読める |
| 2 | `120` Problem 2 source wording / emitted schema split | `Macro 5/6` | Problem 2 source wording / emitted schema residual を witness-provider public shape residual から切り離して narrow にする | `M` | source wording / emitted schema reopen point が独立 package として読める |
| 3 | `121` Problem 2 witness-provider public-shape split | `Macro 5/6` | Problem 2 witness/provider public-shape residual を source wording residual から切り離して narrow にする | `M` | witness-provider public-shape reopen point が独立 package として読める |
...
- current self-driven queue は queue zero ではなく、Package 119 Problem 1 model-check public-contract split、Package 120 Problem 2 source wording / emitted schema split、Package 121 Problem 2 witness-provider public-shape split と later mixed/user-spec residual を含む。
