...
|---|---|---|---|---|---|
| 1 | `58` helper / CLI hardening and broader coverage | `Macro 5/7` | actual Lean execution floor を representative sample setからどう widen し、helper/CLI 側をどこまで硬くするか | `M` | `samples/lean/current-l2/` と sync helper を基点に、broader theorem-side / diagnostics / order-handoff corpus widening が narrow package で通る |
