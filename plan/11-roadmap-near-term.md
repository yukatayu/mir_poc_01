...
|---|---|---|---|---|---|
| 1 | `75` parser-to-checker-reconnect-freeze ratchet | `Macro 5/7` | minimal-parser-subset-freeze threshold の次段として parser-to-checker reconnect freeze ready sketch をどこまで helper-local summary に近づけるか | `M` | parser floor と checker floor の reconnect bundle を narrow に actualize しつつ、final parser grammar や final public parser/checker API を still later に残せる |
...
- current self-driven queue は queue zero ではなく、parser-to-checker-reconnect-freeze ratchet を含む。
