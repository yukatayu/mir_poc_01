...
|---|---|---|---|---|---|
| 1 | `125` Problem 2 final-public-seam lane follow-up | `Macro 5/6` | Problem 2 mixed gate を final wording / witness-provider public-shape cluster として further narrow に扱う | `M` | Problem 2 mixed gate lane が helper / docs / snapshot で同じ順序に見える |
| 2 | `126` syntax-modality final-marker lane follow-up | `Macro 5` | final modal foundation / source marker を Problem-local seam と true user-spec residual から切り分けたまま圧縮する | `S` | syntax/modality lane が Problem 1 / Problem 2 / user-spec residual と混ざらず読める |
...
- current self-driven queue は queue zero ではなく、Package 125 Problem 2 final-public-seam lane follow-up、Package 126 syntax-modality final-marker lane follow-up と later mixed/user-spec residual を含む。
