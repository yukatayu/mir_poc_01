...
|---|---|---|---|---|---|
| 1 | `121` Problem 2 witness-provider public-shape split | `Macro 5/6` | Problem 2 witness/provider public-shape residual を source wording residual から切り離して narrow にする | `M` | witness-provider public-shape reopen point が独立 package として読める |
...
- current self-driven queue は queue zero ではなく、Package 121 Problem 2 witness-provider public-shape split と later mixed/user-spec residual を含む。
