...
- Phase 5 は `specs/examples/126...252` までで theorem-line later package close であり、**next promoted line は `minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison`** である。
...
### 1. minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison を Phase 5 later reopen の current promoted line として扱う

- `retained_payload_body_materialization_theorem_export_handoff_transport_receipt_row` を current first cut に置いた前提で、handoff transport channel body を theorem-line retained bridge にどこまで近づけるかを整理する
...
|---|---|---|
| minimal-handoff-transport-receipt-ready handoff-transport-channel-body comparison | 1〜3 task | current promoted line |
