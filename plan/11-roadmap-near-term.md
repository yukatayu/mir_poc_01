...
|---|---|---|---|---|---|
| 1 | `117` Problem 1 typed source principal split | `Macro 5/7` | Problem 1 typed residual を theorem/model-check public-contract residual から切り離して narrow にする | `M` | typed source principal reopen point が独立 package として読める |
| 2 | `118` Problem 1 theorem public-contract split | `Macro 5/7` | Problem 1 theorem public-contract residual を typed / model-check residual から切り離して narrow にする | `M` | theorem public-contract reopen point が独立 package として読める |
| 3 | `119` Problem 1 model-check public-contract split | `Macro 5/7` | Problem 1 model-check public-contract residual を typed / theorem residual から切り離して narrow にする | `M` | model-check public-contract reopen point が独立 package として読める |
| 4 | `120` Problem 2 source wording / emitted schema split | `Macro 5/6` | Problem 2 source wording / emitted schema residual を witness-provider public shape residual から切り離して narrow にする | `M` | source wording / emitted schema reopen point が独立 package として読める |
| 5 | `121` Problem 2 witness-provider public-shape split | `Macro 5/6` | Problem 2 witness/provider public-shape residual を source wording residual から切り離して narrow にする | `M` | witness-provider public-shape reopen point が独立 package として読める |
...
- current source:
  `specs/examples/589`
- current recommendation:
  checker-adjacent principal / structural marker first / finite decidable index fragment first を保ったまま、typed source principal residual を theorem/model-check public-contract residual から切り離して narrow にする。
- stop line:
  final typed source principal
  final typed calculus
  final public verifier contract
...
- current source:
  `specs/examples/589`
- current recommendation:
  review-unit transport first / notebook-consumer object first / theorem-first pilot keep を保ったまま、theorem public-contract residual を typed / model-check residual から切り離して narrow にする。
- stop line:
  final public theorem contract
...
- current source:
  `specs/examples/589`
- current recommendation:
  row-local property route first / checker-artifact route first / reopen-threshold helper mirror keep を保ったまま、model-check public-contract residual を typed / theorem residual から切り離して narrow にする。
- stop line:
...
- current source:
  `specs/examples/589`
- current recommendation:
  edge-row principal / stage-block secondary / serial reserve keep を保ったまま、source wording / emitted schema residual を witness-provider public-shape residual から切り離して narrow にする。
- stop line:
...
- current source:
  `specs/examples/589`
- current recommendation:
  claim/payload split first / route-schema split first / authoritative-room representative pair keep を保ったまま、witness-provider public-shape residual を source wording residual から切り離して narrow にする。
- stop line:
  final public witness/provider/artifact contract
  stronger fairness / replay profile
  exhaustive shared-space catalog
...
- current self-driven queue は queue zero ではなく、Package 117 Problem 1 typed source principal split、Package 118 Problem 1 theorem public-contract split、Package 119 Problem 1 model-check public-contract split、Package 120 Problem 2 source wording / emitted schema split、Package 121 Problem 2 witness-provider public-shape split と later mixed/user-spec residual を含む。
