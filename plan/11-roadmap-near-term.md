...
|---|---|---|---|---|---|
| 1 | `120` Problem 2 source wording / emitted schema split | `Macro 5/6` | Problem 2 source wording / emitted schema residual を witness-provider public shape residual から切り離して narrow にする | `M` | source wording / emitted schema reopen point が独立 package として読める |
| 2 | `121` Problem 2 witness-provider public-shape split | `Macro 5/6` | Problem 2 witness/provider public-shape residual を source wording residual から切り離して narrow にする | `M` | witness-provider public-shape reopen point が独立 package として読める |
...
- current self-driven queue は queue zero ではなく、Package 120 Problem 2 source wording / emitted schema split、Package 121 Problem 2 witness-provider public-shape split と later mixed/user-spec residual を含む。
