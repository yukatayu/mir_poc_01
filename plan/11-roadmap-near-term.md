...
|---|---|---|---|---|---|
| 1 | `delegated-rng-service` | `Macro 6` | provider placement practical line を first actual default の後段で narrow actualization する | `M` | authority placement と provider placement の差分が helper / docs / scenario loop で追える |
| 2 | `model-check-second-line` | `Macro 5/6` | row-local property carrier second-line を public checker finalization と切り離したまま narrow actualization する | `M` | property carrier / tool seam / public seam residual が problem1 lane と干渉せず追える |
