...
- 次の narrow step は、stable cluster actualization を前提に additive coexistence を維持したまま shrink 保留条件を docs-first に固定するか、parser boundary / checker boundary 側へ主線を戻すかの整理である
