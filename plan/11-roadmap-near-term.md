...
### 2. stable malformed capability second source-backed widening actualization
...
- `Macro 4`
- `e13/e20` pair judgment を保ったまま、source-authored static-stop pair widening を actual source package にどう落とすかを整理する。
