...
|---|---|---|---|---|---|
| 1 | `123` remaining mixed-gate compression after split closeout | `Macro 5/6/7` | remaining mixed gate と true user-spec residual を compare debt を増やさず narrow に圧縮する | `M` | mixed gate / true user-spec residual の境界が queue drift なく読める |
...
- current self-driven queue は queue zero ではなく、Package 123 remaining mixed-gate compression after split closeout と later mixed/user-spec residual を含む。
