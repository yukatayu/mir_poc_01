...
- Phase 5 は `specs/examples/126...230` までで theorem-line later package close であり、**next promoted line は `minimal-authority-stage-local-obligation-family-ready stage-local-obligation-row-detail comparison`** である。
...
### 1. minimal-authority-stage-local-obligation-family-ready stage-local-obligation-row-detail comparison を Phase 5 later reopen の current promoted line として扱う

- `retained_payload_body_materialization_theorem_export_authority_transition_stage_local_obligation_family` を current first cut に置いた前提で、actual stage-local obligation row detail を theorem-line retained bridge にどこまで近づけるかを整理する
...
|---|---|---|
| minimal-authority-stage-local-obligation-family-ready stage-local-obligation-row-detail comparison | 1〜3 task | current promoted line |
