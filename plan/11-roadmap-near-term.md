...
### 1. minimal-public-checker-entry-criteria-ready public-checker-command-surface comparison を Phase 5 の current promoted line として扱う
...
|---|---|---|
| minimal-public-checker-entry-criteria-ready public-checker-command-surface comparison | 1〜3 task | current promoted line |
