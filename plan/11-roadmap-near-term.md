...
|---|---|---|---|---|---|
| 1 | `124` Problem 1 final-public-seam lane follow-up | `Macro 5/7` | Problem 1 mixed gate を typed / theorem / model-check public seam cluster として further narrow に扱う | `M` | Problem 1 mixed gate lane が helper / docs / snapshot で同じ順序に見える |
| 2 | `125` Problem 2 final-public-seam lane follow-up | `Macro 5/6` | Problem 2 mixed gate を final wording / witness-provider public-shape cluster として further narrow に扱う | `M` | Problem 2 mixed gate lane が helper / docs / snapshot で同じ順序に見える |
| 3 | `126` syntax-modality final-marker lane follow-up | `Macro 5` | final modal foundation / source marker を Problem-local seam と true user-spec residual から切り分けたまま圧縮する | `S` | syntax/modality lane が Problem 1 / Problem 2 / user-spec residual と混ざらず読める |
...
- current source:
  ...
  `specs/examples/592`
- current recommendation:
  `reopen-map problem1`、`matrix problem1`、`bundle problem1`、`residuals` を主 anchor に、Problem 1 final public seam lane を typed / theorem / model-check reopen orderとして further narrow に扱う。
- stop line:
  final public theorem contract
  final public checker artifact
  final public verifier contract
...
- current source:
  ...
  `specs/examples/594`
- current recommendation:
  `reopen-map problem2`、`matrix problem2`、`bundle problem2`、`residuals` を主 anchor に、Problem 2 final public seam lane を final wording / witness-provider public-shape reopen order として further narrow に扱う。
- stop line:
  final source-surface handoff wording
  final public witness/provider/artifact contract
  exhaustive shared-space catalog
...
- current recommendation:
  `residuals` helper を主 anchor に、final modal foundation / source marker を Problem-local seam と true user-spec residual から切り分けたまま later mixed gate として圧縮する。
- stop line:
...
- current self-driven queue は queue zero ではなく、Package 124 Problem 1 final-public-seam lane follow-up、Package 125 Problem 2 final-public-seam lane follow-up、Package 126 syntax-modality final-marker lane follow-up と later mixed/user-spec residual を含む。
