...
|---|---|---|
| authored-row widen actualization + theorem-side plain bridge sketch actualization | 2〜4 task | widen sequencing と bridge-sketch reopen ordering は fixed 済みであり、remaining `e21 -> e3` line と theorem-side next reopen timing を narrow に接続する |
