...
|---|---|---|---|---|---|
| 1 | `61` order-handoff/shared-space residual mixed-gate compression | `Macro 5/6/7` | source wording / emitted-artifact / witness-provider public-contract residual をどの reopen order で narrow に残すか | `M` | edge-row principal と route/schema actual adoption を保ったまま residual order を sharpen できる |
