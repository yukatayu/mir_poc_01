...
- Lean sample corpus and first foundations は、
  ...
  を `specs/examples/521`、`522`、`523`、`524` で current package 読みに固定した。
...
- representative Lean sample set actual Lean execution after global toolchain install と helper/CLI surface preview / negative-pair carry-over / IFC checker-hint preview actualization / theorem-model-check helper preview widening / reopen-threshold helper mirror / order-handoff-shared-space public-seam helper mirror / IFC actual-checker-payload-family threshold helper mirror / IFC checker-payload-row-family threshold helper mirror は `specs/examples/518`、`519`、`523`、`524`、`525`、`526`、`527`、`528`、`529`、`530`、`532`、`533`、`534`、`535` を current execution-side anchor にする。
