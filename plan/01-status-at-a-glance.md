...
- current practical devtools floor は `VIS-A1-01/02/03/04/05/06/07` に限られ、current practical save/load floor は `SL-A1-01/02/03` に限られる。remaining reopen point は `PE2E-06` source-carrier alignment、broader save/load widening、same-session runtime semantics、または同程度に narrow な exact-evidence widening に縮小した
