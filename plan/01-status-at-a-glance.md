...
- package 6 以降は network transport plan、compiler/backend/LLVM prep guardrail、hands-on closeout、`NET-01` helper-local preview、avatar representative slice、その後の hot-plug / `NET-02..05`
