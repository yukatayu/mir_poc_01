...
- 主眼は **Mir** の意味論基盤である。
- current repo は architecture-first だが、parser-free PoC、compile-ready minimal actualization、fixed-subset source sample authored sixteen、runnable prototype sample octet を already 持つ。
...
- corrected runnable prototype sample は `p01 / p02 / p03 / p04 / p05 / p06 / p07 / p08` の octet までである。
