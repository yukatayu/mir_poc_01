...
- current practical devtools floor は `VIS-A1-01/02/03/04/05/06/07` に限られ、remaining reopen point は broader save/load widening、same-session runtime semantics、または同程度に narrow な exact-evidence widening に縮小した
