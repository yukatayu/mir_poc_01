...
- `docs/reports/0997-*` で post-`P21` final public hot-plug ABI family third recommendation を close し、`plan/38`、`freeze prerequisite fixed; public ABI still unfrozen`、helper-local preview naming / runtime-private naming / public candidate naming の non-equivalence、remaining open gate = actual `U1` commitment を snapshot / roadmap / reader-facing docs に actualize した
