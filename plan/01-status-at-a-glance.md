...
| `Macro 5` typed / theorem / model-check / order-handoff line | repo-local near-end completion closeout active | self-driven |
...
- authoritative-room runnable scenario loop hardening は、
  - `emit-scenario problem2`
  - `target/current-l2-guided/problem2-scenario-bundle`
  - `p07 / p08 / p09 / p13 / p14`
  を repo-local output dir に materialize できる current cut まで actualize 済みである。
