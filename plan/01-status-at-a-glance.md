...
- 主眼は **Mir** の意味論基盤である。
- current repo は architecture-first だが、parser-free PoC、compile-ready minimal actualization、fixed-subset source sample authored sixteen、runnable prototype sample nonet を already 持つ。
