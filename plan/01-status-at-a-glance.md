...
- post-`P20` current promoted-next package と package-level reopen next はまだ昇格させない。completed engine、rollback、durable migration、distributed activation ordering、final public hot-plug ABI を扱う package は narrow current evidence なしにでっち上げない
