...
- representative Lean sample set actual Lean execution after global toolchain install と helper/CLI surface preview actualization は `specs/examples/518`、`519`、`523`、`524`、`525`、`526` を current execution-side anchor にする。
