...
4. next topic は mixed gate
   ...
   - next active line は phase6-reserve-formal-tool-binding-inventory ratchet と later mixed/user-spec residual に置く
...
44. current active line は phase6-reserve-formal-tool-binding-inventory ratchet、および later mixed/user-spec residual
