...
4. next topic は mixed gate
   ...
   - next active line は phase6-parser-second-tranche-attached-slot-and-predicate-fragment-first-package ratchet と later mixed/user-spec residual に置く
...
44. current active line は phase6-parser-second-tranche-attached-slot-and-predicate-fragment-first-package ratchet、および later mixed/user-spec residual
