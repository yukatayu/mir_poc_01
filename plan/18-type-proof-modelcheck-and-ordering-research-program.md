...
- 2026-04-20 FAQ 10 後の once-through completion handoff integration により、Package 91...106 は
  ...
  の staged self-driven sequence として読む。Package 118 close 後の current active line は Package 119 Problem 1 model-check public-contract split、Package 120 Problem 2 source wording / emitted schema split、Package 121 Problem 2 witness-provider public-shape split に narrow 化した。
...
45. current active line は Package 119 Problem 1 model-check public-contract split、Package 120 Problem 2 source wording / emitted schema split、Package 121 Problem 2 witness-provider public-shape split、および later mixed/user-spec residual
