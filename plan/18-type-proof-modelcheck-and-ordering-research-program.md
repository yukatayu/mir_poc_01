...
4. next topic は mixed gate
   ...
   - next active line は order-handoff/shared-space residual mixed-gate compression と later true user-spec residual に置く
...
44. current active line は order-handoff/shared-space residual mixed-gate compression、および later true user-spec residual
