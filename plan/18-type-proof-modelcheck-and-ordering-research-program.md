...
4. next topic は mixed gate
   ...
   - next active line は layered strong typing / IFC first-fragment、residual mixed-gate compression、および later true user-spec residual に置く
...
44. current active line は layered strong typing / IFC first-fragment、residual mixed-gate compression、および later true user-spec residual
