...
4. next topic は mixed gate
   ...
   - next active line は shared-output-contract ratchet と later mixed/user-spec residual に置く
...
44. current active line は shared-output-contract ratchet、および later mixed/user-spec residual
