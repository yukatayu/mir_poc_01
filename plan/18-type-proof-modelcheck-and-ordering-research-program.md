...
- 2026-04-20 FAQ 10 後の once-through completion handoff integration により、Package 91...106 は
  ...
  の staged self-driven sequence として読む。Package 122 close 後の current active line は remaining mixed-gate compression に narrow 化し、その後 FAQ 11 と reserve package summary index actualization を踏まえた current reading では active self-driven package は `model-check-second-line` に further narrow 化した。
...
- `specs/examples/521...611` により、Lean first slice、IFC / finite-index widening、
