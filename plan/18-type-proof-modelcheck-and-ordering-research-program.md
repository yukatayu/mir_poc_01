...
4. next topic は mixed gate
   ...
   - next active line は phase2-parser-free-poc-closeout ratchet と later mixed/user-spec residual に置く
...
44. current active line は phase2-parser-free-poc-closeout ratchet、および later mixed/user-spec residual
