...
4. next topic は mixed gate
   ...
   - next active line は checker payload row-family ratchet と later mixed/user-spec residual に置く
...
44. current active line は checker payload row-family ratchet、および later mixed/user-spec residual
