...
- current live queue は Package 130 Problem 1 executable residual reopen sync、Package 131 Problem 2 executable residual reopen sync、Package 132 repo-local once-through closeout sync after executable loops、および later mixed/user-spec residual に移したと読む。
...
45. current active line は Package 130...132 executable residual reopen / closeout sync、および later mixed/user-spec residual
