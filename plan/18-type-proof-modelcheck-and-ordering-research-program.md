...
- 2026-04-20 FAQ 10 後の once-through completion handoff integration により、Package 91...106 は
  ...
  の staged self-driven sequence として読む。Package 114 close 後の current active line は Package 115 Problem 1 theorem/model-check mixed-gate split refresh と Package 116 Problem 2 order-handoff/public-shape mixed-gate split refresh に narrow 化した。
...
45. current active line は Package 115 Problem 1 theorem/model-check mixed-gate split refresh、Package 116 Problem 2 order-handoff/public-shape mixed-gate split refresh、および later mixed/user-spec residual
