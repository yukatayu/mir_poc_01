...
- 2026-04-20 FAQ 10 後の once-through completion handoff integration により、Package 91...98 は
  ...
  の staged self-driven sequence として読む。
...
45. current active line は Package 98 docs/report closeout、および later mixed/user-spec residual
