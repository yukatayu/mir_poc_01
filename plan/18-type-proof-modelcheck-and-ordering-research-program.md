...
- current live queue は Package 123 remaining mixed-gate compression after split closeout、
...
45. current active line は Package 123 remaining mixed-gate compression after split closeout、および later mixed/user-spec residual
