...
- representative sample expectation は、
  ...
  を current next widening target に置く。
...
44. current active line は fixed-subset-source-sample-corpus-scope-and-file-layout ratchet、および later mixed/user-spec residual
45. remaining actual-adoption topics は mixed gate
