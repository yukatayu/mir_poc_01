...
4. next topic は mixed gate
   ...
   - next active line は phase6-actual-checker-runtime-skeleton-first-tranche ratchet と later mixed/user-spec residual に置く
...
44. current active line は phase6-actual-checker-runtime-skeleton-first-tranche ratchet、および later mixed/user-spec residual
