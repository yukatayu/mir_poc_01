...
- `specs/examples/521...595` により、Lean first slice、IFC / finite-index widening、
  ...
  split helper 群、reopen-map split closeout sync まで actualize 済みである。
- current live queue は Package 124 Problem 1 final-public-seam lane follow-up、
...
45. current active line は Package 124 Problem 1 final-public-seam lane follow-up、Package 125 Problem 2 final-public-seam lane follow-up、Package 126 syntax-modality final-marker lane follow-up、および later mixed/user-spec residual
