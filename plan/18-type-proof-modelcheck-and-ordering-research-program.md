...
4. next topic は mixed gate
   ...
   - next active line は minimal-parser-subset-freeze ratchet と later mixed/user-spec residual に置く
...
44. current active line は minimal-parser-subset-freeze ratchet、および later mixed/user-spec residual
