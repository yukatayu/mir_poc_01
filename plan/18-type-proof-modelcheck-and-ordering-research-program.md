...
- 2026-04-20 FAQ 10 後の once-through completion handoff integration により、Package 91...102 は
  ...
  の staged self-driven sequence として読む。Package 102 close 後の current active line は Package 103 parser-side companion surface bundle と Package 104 parser-side bundle-to-helper bridge に narrow 化した。
...
45. current active line は Package 103 parser-side companion surface bundle、Package 104 parser-side bundle-to-helper bridge、および later mixed/user-spec residual
