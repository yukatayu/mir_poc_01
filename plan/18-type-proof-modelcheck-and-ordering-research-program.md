...
- current live queue は Package 129 authoritative-room runnable scenario hardening、および later mixed/user-spec residual に移したと読む。
...
45. current active line は Package 129 authoritative-room runnable scenario hardening、および later mixed/user-spec residual
