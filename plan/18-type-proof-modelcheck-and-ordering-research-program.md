...
4. next topic は mixed gate
   ...
   - next active line は parser-to-checker-reconnect-freeze ratchet と later mixed/user-spec residual に置く
...
44. current active line は parser-to-checker-reconnect-freeze ratchet、および later mixed/user-spec residual
