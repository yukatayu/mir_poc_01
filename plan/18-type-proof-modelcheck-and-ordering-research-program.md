...
4. next topic は mixed gate
   ...
   - next active line は phase6-next-reopen-sequencing ratchet と later mixed/user-spec residual に置く
...
44. current active line は phase6-next-reopen-sequencing ratchet、および later mixed/user-spec residual
