...
4. next topic は mixed gate
   ...
   - next active line は phase5-proof-protocol-runtime-policy-handoff-closeout ratchet と later mixed/user-spec residual に置く
...
44. current active line は phase5-proof-protocol-runtime-policy-handoff-closeout ratchet、および later mixed/user-spec residual
