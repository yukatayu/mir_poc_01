...
4. next topic は mixed gate
   ...
   - next active line は public-checker-boundary ratchet と later mixed/user-spec residual に置く
...
44. current active line は public-checker-boundary ratchet、および later mixed/user-spec residual
