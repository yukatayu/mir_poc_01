...
4. next topic は mixed gate
   ...
   - next active line は typed/IFC helper-to-checker ratchet と later mixed/user-spec residual に置く
...
44. current active line は typed/IFC helper-to-checker ratchet、および later mixed/user-spec residual
