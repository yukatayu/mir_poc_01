...
4. next topic は mixed gate
   ...
   - next active line は layered strong typing / IFC first-fragment、Lean formal skeleton / proof obligations、actual Lean execution helper/CLI hardening と broader coverage、および later mixed gate に置く
...
44. current active line は layered strong typing / IFC first-fragment、Lean formal skeleton / proof obligations、actual Lean execution helper/CLI hardening と broader coverage、および later mixed gate
