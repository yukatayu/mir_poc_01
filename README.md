...
- Full System V1 final packet/FFI transport semantics, executable server/client split, broader source-first sample realization beyond the current bounded release-check workflow, and final claim/non-claim audit
