...
- Full System V1 packet/FFI payload schema semantics, executable server/client split, provider admission, and broader source-first sample realization
