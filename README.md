...
- Surface Mir checker / runtime implementation beyond the P-SURF-01 parser floor
...
- Surface Mir source operational suite beyond the current docs/spec rebaseline
