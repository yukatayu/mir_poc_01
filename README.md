...
- Full System V1 final packet/FFI transport semantics, executable server/client split, renderer pose backend, broader source-first sample realization, and final release check
