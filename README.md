...
- **Mirrorea Spaces practical alpha-1 line**
  ...
  ただし、これは promoted work queue であり、active canonical runnable root への昇格を意味しません。2026-05-05 時点の latest package closeout は `P-A1-22` α-0.9 session-bound devtools export です。
