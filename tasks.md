...
- 2026-04-30 の guided helper / bundle / matrix / quickstart cluster cooling、finite-index typing / Lean formal skeleton stale-path cooling、IFC representative carry-over stale-path half cooling は maintenance-only closeout であり、`specs/examples/572..582`、`585..587`、`600`、`566/567`、`522/523/524/529`、`specs/12 D-111/D-112/D-117/D-151/D-152/D-157..169/D-170..172/D-185`、`specs/11`、`specs/00`、archived `samples/old/2026-04-22-pre-clean-near-end/problem-bundles/` を historical helper memory / archived bundle memory / clean-near-end `check-source-sample` current surface / active `samples/lean/clean-near-end/` vs archived old corpus split / archived pre-clean-near-end prototype anchor split / active clean-near-end typing `01/02/03` compare floor に同期しただけで、new implementation queue は reopened していません。remaining stale-docs line は `specs/examples/525/527/528` に残る order-handoff representative carry-over wordingです。
