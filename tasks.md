...
OPEN; its A/A minimum is advisory and does not close a row. Nothing selects
a relation schema, transition, source form, runtime, proof, or Canon amendment.
...
- Plan 227 は P017 X1 の通常設計で何を一つの tuple として比較するかを固定した。
  ...
  recommendation である。K1 は failure row の Canon gap として止める。
