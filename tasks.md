...
| 27 | OBL-025 diagnostic completeness source cut (unselected) | Audit Line-1 repair completeness against canon theory/10 while keeping existing LAB repair draft, edit/coverage semantics, Diagnostic ABI, and status unpromoted. | Macro 1/5 reserve; research-selected |
...
| OBL-024 | a proof-facing diagnostic emission / association / replay relation | theory/10 fixes target direction and field vocabulary, but T-RESEARCH-026 found no emitted-diagnostic association, rule/premise/binding, replay/exact-at, span, or equality/ordering relation. Existing projection/draft remains LAB evidence; stop before selecting those interfaces. |
| OBL-025 | a proof-facing Line-1 repair-coverage relation | theory/10 fixes the target direction and initial repair taxonomy; the LAB draft remains compile-check-only. The next source audit must not promote it or select a final Diagnostic/repair ABI. |
