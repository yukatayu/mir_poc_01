...
is not a Canon branch model. Plan 223 then selected and WRK-0042 registered the
distinct supplied owner-terminal-negative / owner-mutation detector; it is
unexecuted and is not a failure or mutation model.
...
- P017 X1 の selected scope では、WRK-0042 の登録済み bounded detector を実行できる。
  その後は、独立した source condition と falsifier がない Boolean table 拡張をしない。
...
| Plan 199 C1--C5 | value flow, receipt, service/admission occurrence | P017 X1 relation-state envelope | X1 is recorded and limited to V1/R1 cross-locus reads. WRK-0040 detected five collapsed cases; WRK-0041 detected owner-terminal overlap; WRK-0042 is registered to inspect supplied owner-negative/mutation overlap only. Schema/rule/proof remain unselected |
...
- P017 X1 terminal L3 evidence and owner-negative/mutation L3 preregistration:
