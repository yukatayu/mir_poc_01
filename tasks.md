...
- Plan 227 は P017 X1 の通常設計で何を一つの tuple として比較するかを固定した。
  ...
  fallback とした。Theory 04 は generic occurrence kind / receive rule を供給しない。
  次は fresh cut での ADR-0014 standing recheck と、通る場合だけの別 WRK preregistration
  である。K1 は failure row の Canon gap。
