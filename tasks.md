...
until a positive native basis or erasable derivation is supplied. Nothing selects
...
- Plan 227 は P017 X1 の通常設計で何を一つの tuple として比較するかを固定した。
  ...
  positive basis 待ちの OPEN として残す。K1 は failure row の Canon gap として止める。
