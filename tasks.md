...
- `plan/152-discord-notification-file-inputs.md` now records the P105
  notification operation hardening: `discord_notify.py` accepts
  `--summary-file` and `--next-step-file` so shell-sensitive notification text
  can bypass inline command-argument quoting. This is operational hardening
  only, not a delivery guarantee or phase / gate movement.
...
- P105 Discord notification file-input hardening adds file-based summary /
  ...
  change webhook secret storage, delivery guarantees, task begin/progress/
  complete semantics, phase/gate status, proof/conformance, runtime readiness,
  or sample status.
...
- `plan/132-g1-status-evidence-readiness-dry-run.md` now records the
  evidence-readiness checks a future packet would cite for OBL-001 / OBL-020 /
  OBL-021: direct Lean compile-checks passed, sync guards passed, and a
  targeted admitted-stub / placeholder-body scan found no matches. This is
  proposal preparation only; it does not choose requested status, submit a
  ...
  status.
- `plan/133-g1-requested-status-options-matrix.md` now compares `stated` and
  `lean-stated` as future requested-status candidates for OBL-001 / OBL-020 /
  OBL-021. It keeps the result advisory: OBL-001 is the strongest later
  `lean-stated` candidate if artifact identity or wrapper acceptance is
  ...
  boundary is accepted. It does not accept requested status, submit a proposal, edit
  canon, move the ledger, complete an OBL, discharge proof, claim conformance,
  claim G1 exit, change runtime readiness, or relabel sample status.
- `plan/134-g1-obl020-scope-clarification-packet.md` now splits OBL-020's
  future proposal posture into B: G1-supporting statement-scope clarification,
  A: full-row status movement deferred, and C: proof-package fallback only if
  scoped statement identity is rejected. It does not accept requested status,
  submit a proposal, edit canon, move the ledger, complete OBL-020, discharge
  proof, claim conformance, claim G1 exit, change runtime readiness, or relabel
  sample status.
- `plan/135-g1-obl020-artifact-identity-wrapper-preflight.md` now limits direct
  citation of the LAB OBL-020 Lean artifact to LAB evidence and says any later
  requested-status packet needs an artifact-identity annex / wrapper decision.
  The default is annex-only preflight now; actual wrapper creation is deferred
  unless human/canon review requires it. It does not accept requested status,
  submit a proposal, create a wrapper file, edit canon, move the ledger,
  complete OBL-020, discharge proof, claim conformance, claim G1 exit, change
  runtime readiness, or relabel sample status.
- `plan/136-g1-obl020-artifact-annex-template.md` now defines the non-applied
  OBL-020 artifact annex template for a later requested-status packet. It maps
  the canon OBL-020 target to the LAB artifact path / namespace / constant and
  records scope label, fresh validation slots, artifact / scope decision
  slots, unresolved concrete-definition items, and non-claims. It does not
  accept requested status, submit a proposal, create a wrapper file, edit
  canon, move the ledger, complete OBL-020, discharge proof, claim conformance,
  claim G1 exit, change runtime readiness, or relabel sample status.
- `plan/137-g1-obl001-artifact-identity-wrapper-preflight.md` now limits direct
  citation of the LAB OBL-001 Lean artifact to LAB evidence and says any later
  `lean-stated` packet needs an artifact-identity annex / wrapper decision.
  OBL-001 remains the strongest later `lean-stated` candidate, but actual
  wrapper creation is deferred unless human/canon review requires it. It does
  not accept requested status, submit a proposal, create a wrapper file, edit
  canon, move the ledger, complete OBL-001, discharge OBL-002 proof, claim
  conformance, claim G1 exit, change runtime readiness, or relabel sample
  status.
- `plan/138-g1-obl001-artifact-annex-template.md` now defines the non-applied
  OBL-001 artifact annex template for a later `lean-stated` packet. It maps
  the canon OBL-001 target to the LAB artifact path / namespace / constant and
  records OPEN-014 deferral, simple-assignment scope, fresh validation slots,
  artifact / scope decision slots, unresolved proof / conformance items, and
  non-claims. It does not accept requested status, submit a proposal, create a
...
- `plan/139-g1-obl021-artifact-identity-wrapper-preflight.md` now limits direct
  ...
  conformance, claim G1 exit, change runtime readiness, or relabel sample
  status.
- `plan/140-g1-obl021-artifact-annex-template.md` now defines the non-applied
  OBL-021 artifact annex template for a later conditional `lean-stated` packet.
  It maps the canon OBL-021 target to the LAB artifact path / namespace /
  constant and records abstraction-boundary decision slots, fresh validation
  slots, artifact / wrapper decision slots, unresolved final equality /
  Diagnostic ABI / projection-totality items, and non-claims. It does not
  accept requested status, submit a proposal, create a wrapper file, edit
  canon, move the ledger, complete OBL-021, discharge proof, choose final
  equality / Diagnostic ABI, claim conformance, claim G1 exit, change runtime
  readiness, or relabel sample status.
- `plan/141-g1-status-packet-shell-unresolved-slots.md` now defines the
  non-applied G1 OBL status packet shell that references the OBL-001 /
  OBL-020 / OBL-021 annex templates. It keeps requested status, ledger delta,
  artifact identity acceptance, wrapper need, OPEN-014 handling, OBL-020
  scope, OBL-021 abstraction boundary, proof, conformance, runtime, and G1 exit
  unresolved. It does not submit a proposal, accept requested status, edit
  canon, move the ledger, complete any OBL, claim proof / conformance, change
  runtime readiness, or relabel sample status.
- `plan/142-g1-status-packet-shell-evidence-dry-run.md` now records the fresh
  LAB evidence dry-run for the validation slots named by `plan/141`: OBL-001 /
  ...
  tracked secret scan. It does not choose requested status, submit a proposal,
  edit canon, move the ledger, complete any OBL, claim proof / conformance,
  change runtime readiness, or relabel sample status.
- `plan/143-g1-obl021-equality-diagnostic-abstraction-decision-packet.md` now
  separates the OBL-021 equality / diagnostic abstraction blocker from the
  status shell. It asks what human/canon review should decide about abstract
  result equivalence, abstract diagnostic equivalence, projection-totality,
  fixed-input identity, and LAB artifact / wrapper identity before any OBL-021
  status draft. It also
  clarifies the later reading of `plan/77`: abstract predicate fields may be
  accepted for statement-status vocabulary, replaced by concrete relations
  first, or deferred. It does not choose requested status, submit a proposal,
  edit canon, move the ledger, complete OBL-021, claim proof / conformance,
...
- `plan/144-g1-obl020-scope-decision-reuse-audit.md` now confirms that
  ...
  readiness, or relabel sample status.
- `plan/145-g1-obl001-artifact-decision-reuse-audit.md` now confirms that
  `plan/137` / `plan/138` already control the OBL-001 artifact identity /
  wrapper / OPEN-014 / simple-assignment decision surface. The previous
  candidate "OBL-001 artifact identity / wrapper acceptance review" should not
  be rerun as a duplicate preflight or annex; if human/canon review is
  explicitly promoted, the safe move is a review-facing extraction from
  `plan/137` / `plan/138`. It does not choose requested status, submit a
  proposal, edit canon, move the ledger, complete OBL-001, discharge OBL-002
  proof, claim conformance, create a wrapper, resolve OPEN-014, claim G1 exit,
  change runtime readiness, or relabel sample status.
- `plan/146-g1-obl001-explanation-boundary-guard-hardening.md` now closes a
  concrete OBL-001 sync-guard drift risk. `THM001StatementDraft.md` must keep
  LAB/canon hierarchy, non-identity with canon `MirCore.Elab.Soundness (stmt)`,
  artifact identity / wrapper non-acceptance, and OPEN-014 non-resolution
  wording for the sync test to pass. It does not refine the Lean predicate,
  choose requested status, submit a proposal, edit canon, move the ledger,
...
- `plan/149-current-phase-position-reading.md` now records the phase-position
  reading that should be used for short user-facing answers. It separates canon
  lifecycle state (`T0/G0 rebaseline`, phase 1 of 9 by human count, late
...
- `scripts/README.md` also mirrors the current `check_source_hierarchy.py`
  ...
  `plan/39..149`, including the current G1 E-ROW / OBL addenda, remaining
  ...
  and `plan/118..147`, plus the storage guard `plan/148` and phase-position
  reading `plan/149`. This is
...
- `scripts/validate_docs.py` now rejects numbered `plan/*.md` files that exist
  ...
  cover current numbered `plan/00..149`. This keeps future plan-file additions
...
- `plan/131-g1-status-proposal-packet-outline.md` now turns that criteria
  ...
  move canon status.
- `plan/132-g1-status-evidence-readiness-dry-run.md` now records the
  OBL-001/020/021 compile-check, sync-guard, and admitted-stub /
  placeholder-body scan results that a future status proposal packet can cite.
  It does not choose `stated` vs `lean-stated`, submit a draft proposal, include
  ledger patch text, move canon status, or claim proof / conformance.
- `plan/133-g1-requested-status-options-matrix.md` now compares the requested
  status vocabulary without treating the recommendation as acceptance. It
  recommends OBL-001 as a later `lean-stated` candidate only after artifact
  identity / wrapper acceptance, and keeps OBL-020 full-row status deferred until scope acceptance, and OBL-021
  conditional `lean-stated` pending abstraction-boundary acceptance.
  It does not submit a proposal, include ledger patch text, move canon status,
  or claim proof / conformance.
- `plan/134-g1-obl020-scope-clarification-packet.md` now clarifies that the
  safe near-term OBL-020 posture is G1-supporting statement-scope review, not
  full-row status movement; proof-package deferral remains fallback if canon
  rejects scoped statement identity. It does not submit a proposal, include
  ledger patch text, move canon status, or claim proof / conformance.
- `plan/135-g1-obl020-artifact-identity-wrapper-preflight.md` now clarifies
  that direct citation of the LAB OBL-020 Lean artifact is safe only as LAB
  evidence, while any requested-status artifact identity still needs an annex
  / wrapper decision. It does not create a wrapper, submit a proposal, include
  ledger patch text, move canon status, or claim proof / conformance.
- `plan/136-g1-obl020-artifact-annex-template.md` now provides the fillable
  non-applied annex template for a later OBL-020 requested-status packet. It
  maps the canon ledger target to the current LAB artifact identity and keeps
  requested status, artifact identity acceptance, scope acceptance, concrete
  definitions, proof, conformance, and G1 exit as explicit unresolved slots.
  It does not create a wrapper, submit a proposal, include ledger patch text,
  move canon status, or claim proof / conformance.
- `plan/137-g1-obl001-artifact-identity-wrapper-preflight.md` now clarifies
  that direct citation of the LAB OBL-001 Lean artifact is safe only as LAB
  evidence. It records OBL-001 as the strongest later `lean-stated` candidate,
  while keeping artifact identity acceptance, wrapper need, OPEN-014 deferral,
  OBL-002 proof, conformance, and G1 exit outside this preflight. It does not
  create a wrapper, submit a proposal, include ledger patch text, move canon
  status, or claim proof / conformance.
- `plan/138-g1-obl001-artifact-annex-template.md` now provides the fillable
  non-applied annex template for a later OBL-001 `lean-stated` packet. It keeps
  requested status, artifact identity acceptance, wrapper need, OPEN-014
...
- `plan/140-g1-obl021-artifact-annex-template.md` now provides the fillable
  non-applied annex template for a later OBL-021 conditional `lean-stated`
  packet. It keeps requested status, artifact identity acceptance, wrapper
  need, abstraction-boundary acceptance, final equality, diagnostic
  equivalence, Diagnostic ABI, projection-totality, proof, conformance, and G1
  exit as explicit unresolved slots. It does not create a wrapper, submit a
  proposal, include ledger patch text, move canon status, or claim proof /
  conformance.
- `plan/141-g1-status-packet-shell-unresolved-slots.md` now provides the
  fillable non-applied status packet shell that connects the OBL-001 /
  OBL-020 / OBL-021 annex templates. It keeps requested status, ledger delta,
  artifact identity acceptance, wrapper need, OPEN-014 handling, OBL-020 scope,
  OBL-021 abstraction boundary, proof, conformance, runtime, and G1 exit as
  explicit unresolved slots. It does not create a wrapper, submit a proposal,
  include ledger patch text, move canon status, or claim proof / conformance.
- `plan/142-g1-status-packet-shell-evidence-dry-run.md` now provides the
  fresh shell-target evidence dry-run for `plan/141`. It records that the three
  OBL Lean compile-checks, sync guard, admitted-stub / placeholder scan, docs
  / source hierarchy validation, and tracked secret scan pass as LAB evidence.
  It does not create a wrapper, choose requested status, submit a proposal,
  include ledger patch text, move canon status, or claim proof / conformance.
- `plan/143-g1-obl021-equality-diagnostic-abstraction-decision-packet.md` now
  provides the decision-packet-only split for OBL-021 equality / diagnostic
  abstraction before status drafting. It keeps result equality, diagnostic
  equivalence, projection-totality, fixed-input identity, LAB artifact identity, and wrapper
  requirement as human/canon decision axes and records the later reading of
  `plan/77`'s abstract-predicate replacement question. It does not create a
...
- `plan/145-g1-obl001-artifact-decision-reuse-audit.md` now records that
  `plan/137` / `plan/138` already supply the OBL-001 artifact decision surface
  and that a second artifact identity / wrapper preflight would be duplicate
  work. It keeps requested status, artifact identity acceptance, wrapper need,
  OPEN-014, simple-assignment scope, proof, conformance, runtime readiness, and
  G1 exit unresolved. It does not create a wrapper, choose requested status,
  submit a proposal, include ledger patch text, move canon status, resolve
  OPEN-014, or claim proof / conformance, runtime readiness, or G1 exit.
- `plan/146-g1-obl001-explanation-boundary-guard-hardening.md` now records a
  test-only OBL-001 explanation-boundary guard. It keeps the LAB/canon
  hierarchy, canon-target non-identity, artifact identity / wrapper
