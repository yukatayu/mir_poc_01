...
Current promoted package after `P-SURF-04` closeout:
...
- implement role claim / join admission / capability grant evidence without
  treating a role claim as authority.
- keep admission locus, principal, role, membership freshness, and generated
  capability rows explicit.
- preserve P-SURF-04 generated communication as elaboration evidence only; no
  runtime MessageEnvelope dispatch or final transport claim.
- keep source patch activation and operational Surface roots as later package
  work.
