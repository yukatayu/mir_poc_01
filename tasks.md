...
### Blocker 2. source corpus を representative / fixture とどう分けるか
...
### Blocker 3. actual parser-to-`Program` lowering の first cut
...
### Blocker 4. concrete formal tool binding と backend/codegen timing
...
### Blocker 5. `atomic_cut` sample 拡張と higher-level async-control / low-level memory-order family の関係
