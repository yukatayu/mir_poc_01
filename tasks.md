...
basis. Nothing selects a relation schema, transition, source form, runtime,
...
- Plan 227 は P017 X1 の通常設計で何を一つの tuple として比較するかを固定した。
  ...
  advisory とし、requester pending 等による shortcut を禁止する。K1 は failure row の
  Canon gap として止める。
