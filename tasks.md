...
| `E-ROW repair payload inventory` | `G1` reserve | inventory the non-final repair payload shape if the next code prototype should include `suggested_repair[]` | no repair generation proof or final ABI freeze |
