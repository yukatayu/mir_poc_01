...
and Report 2273's generic closure pattern, not a new theory result. The
displayed predicate does not formalize the parenthetical channel-state branch
or establish interchangeability with event membership. The scratch source stays
