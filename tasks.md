...
- Plan 227 は P017 X1 の通常設計で何を一つの tuple として比較するかを固定した。
  ...
  次はこの gate を守る単一候補 source の materialization であり、harness の有限 atom を
  retained source に持ち込まない。K1 は failure row の Canon gap。
