...
| 26 | theory/10 diagnostic source cut (unselected) | Audit explanation soundness and completeness against canon theory/10 while keeping existing LAB statement drafts, diagnostic/repair ABI, replay relation, and status unpromoted. | Macro 1/5 reserve; research-selected |
...
| OBL-024 / OBL-025 | a proof-facing diagnostic replay relation and Line-1 repair-coverage relation | theory/10 fixes the target directions; existing LAB drafts are compile-check-only and preserve non-final association/replay/repair vocabulary. The next source audit must not promote them or select a final Diagnostic/repair ABI. |
