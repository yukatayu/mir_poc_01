...
Last updated: 2026-05-01 12:59 JST
...
|---|---|---|---|---:|---|---|---|---|
| `PH0` | repository memory | `samples_progress.md`, `docs/reports/`, `scripts/check_source_hierarchy.py` | dashboard / hierarchy check | 90 | mixed | 2026-05-01 12:59 JST | `0945`, `0996`, `0997`, `0998`, `1001`, `1053`, `1066`, `1076`, `1077`, `1078`, `1079`, `1080`, `1081`, `1082`, `1083`, `1084`, `1085`, `1086` | Snapshot docs are maintenance artifacts, not normative specs |
...
| `SUG-03` | Sugoroku handoff | `samples/clean-near-end/sugoroku-world/03_roll_publish_handoff.mir` | active runnable E2E | 90 | positive | 2026-05-01 12:46 JST | `0950`, `0952`, `0954`, `0955`, `0998`, `1066`, `1076`, `1085` | roll -> publish -> witness -> handoff |
| `SUG-05` | membership | `samples/clean-near-end/sugoroku-world/05_late_join_history_visible.mir` | active runnable E2E | 90 | positive | 2026-05-01 12:46 JST | `0955`, `0998`, `1066`, `1076`, `1085` | published history visible before turn insertion |
| `SUG-08` | reset model-check | `samples/clean-near-end/sugoroku-world/08_reset_interleaving_model_check.mir` | active verification E2E | 90 | positive | 2026-05-01 12:46 JST | `0945`, `0998`, `1066`, `1076`, `1085` | reset safety bridge |
| `SUG-09` | hot-plug detach TODO | `samples/clean-near-end/sugoroku-world/09_detach_todo.mir` | active TODO boundary | 75 | rejection evidence | 2026-05-01 12:46 JST | `0977`, `0979`, `0986`, `0994`, `0995`, `0998`, `1066`, `1076`, `1085` | explicit stop line; not completed migration / rollback |
| `FAIRY-01/02/03/04/06` | avatar follow | `samples/clean-near-end/avatar-follow/` | active representative slice | 90 | positive + negative + verification | 2026-05-01 12:46 JST | `0956`, `0978`, `0998`, `1066`, `1076`, `1085` | follow / fallback / stale-anchor rejection / detached-anchor safety |
...
| `EXT-03/04` | typed external | `scripts/typed_external_boundary_samples.py` | helper synthetic preview | 75 | positive + negative | 2026-05-01 12:46 JST | `0966`, `0998`, `1066`, `1076`, `1085` | helper synthetic preview over planned-path sources; not final adapter API |
...
| `NET-02..05` | network transport | `scripts/network_transport_samples.py`, Sugoroku loopback mode | helper-local canary family | 100 | positive + negative | 2026-05-01 12:59 JST | `0967`, `0998`, `1066`, `1075`, `1076`, `1082`, `1085`, `1086` | `check-all` executes NET canaries; `closeout` is inventory-only. `NET-01` is only a reported Sugoroku loopback parity anchor; not production transport |
| `PRJ-01/02` | projection / placement | Sugoroku `projection_view`, runtime `cross_place_projection` | helper/report preview | 75 | positive | 2026-05-01 12:59 JST | `0948`, `0998`, `1066`, `1076`, `1083`, `1085`, `1086` | preview floor; not emitted executable program / equivalence proof |
| `P15-GEN-01..04` | projection / codegen | `samples/generated/projection-placement/manifest.json` | committed generated bridge evidence | 90 | positive | 2026-05-01 12:59 JST | `0970`, `0998`, `1066`, `1076`, `1083`, `1085`, `1086` | generated artifact; alignment inventory only; not source sample / final executable / generated program / optimizer / planner / equivalence checker |
| `P16-VIEW-01..05` | viewer | `scripts/visual_debugger_viewer_samples.py` | typed public prototype inventory | 100 | positive | 2026-05-01 12:46 JST | `0971`, `0998`, `1066`, `1076`, `1085` | typed inventory over helper/runtime surfaces; not final viewer API |
...
| `STORAGE-01` | storage / backend | `/mnt/mirrorea-work`, `scripts/env/`, `scripts/storage/` | operational guardrail | 100 | positive | 2026-05-01 12:46 JST | `0972`, `0998`, `1066`, `1072`, `1076`, `1085` | no destructive cleanup / no actual LLVM build |
